...
public class SecuredCategoryPage {
	...
	// By new_Book = By.xpath ("//a[@class='btn btn-success
	// no-mobile'][contains(text(),'New Book')]");
	By new_Book = By.xpath("//*[@id=\"book-btn\"]/a");
	...
	public void click_Library() {
		...
		WebElement element = driver.findElement(By.xpath("//span[contains(text(),'Library')]"));
	...
	public void click_Generate_Cover_Page() {
	...
	public void user_Can_Create_New_Book_And_Add_Title() throws InterruptedException {
		...
		this.click_Generate_Cover_Page();
		Thread.sleep(1000);
	...
	By workroom_Admin_Added = By.xpath("(//div[@class='person-name']/following::span[@class='icon minus-sign-icon'])[1]"); // looking for minus sign
	...
	// By empProvinceInput = By.xpath("//*[@id='province__listbox']");
	By build_Handbook = By.xpath("//*[@id='publish_button']/a[1] ");
	...
	public void scroll_Up_To_Build_Book() throws InterruptedException {
		// WebElement build_Book =
		// driver.findElement(By.xpath("//a[@class='primary-action-btn btn-sidebar
		// be-blue'][contains(text(),'Build Book')]"));
		WebElement build_Book = driver.findElement(By.xpath("//*[@id='publish_button']/a[1]"));
	...
	By edit_BookBtn = By.xpath("//*[@id='wrap']/main[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/a[1]");
	...
	By book_Title = By.cssSelector("div[id^='card'] > div:nth-of-type(2) > div > h3 > a");
	...
	public void verify_NewCatagory_Not_Visible() {
		String newcategory = "//h3[contains(text(),'New Catagory')]";
		driver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
		boolean category = driver.findElements(By.xpath(newcategory)).size() < 1;
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		if (category == true) {
			Assert.assertTrue(category, "New Catagory NOT present");
		} else {
			WebElement cat = driver.findElement(By.xpath(newcategory));
			Assert.assertFalse(category, cat.getText() + " New Category is Present");
		}
	}
