...
public class PermissionPage {
	...
	public void user_Open_Settings_Then_Workroom_And_Group_Settings() throws InterruptedException {
		...
		Thread.sleep(1000);
		this.click_Manage_Workroom_Groups(); // ---clicking twice to make sure its clicked
		Thread.sleep(3000);
	...
	public void click_Events() throws InterruptedException {
		WebElement autobe = driver.findElement(By.xpath("//a[@class='active'][contains(text(),'AutoBE')]"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", autobe);
		Thread.sleep(1500);
		
		String box = "//input[@id='can_access_events_2305']";
		WebElement checkbox = driver.findElement(By.xpath(box));
		
			if ((checkbox.isSelected())) {
				Thread.sleep(1000);
				// element.click();
				WebElement foo = driver.findElement(By.xpath("//input[@id='can_access_events_2305']"));
				JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	public void scoll_And_Click_SaveBtn() throws InterruptedException {
		...
		// WebElement element2 = driver.findElement(By.xpath("//div[@class='modal-dialog
		// modal-lg']//button[@id='save-user']"));
		WebElement element2 = driver.findElement(By.xpath("(//button[@id='save-user'])[2]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element2);
	}
	...
	By workroom_Admin_Moved = By.xpath(
			"//div[@class='col-sm-12 panel-section-heading'][contains(text(),'Workroom Administrators')]/following::tr[ starts-with (@id,'settings-users-info-')]/td[2]/a");
	...
	By workroom_Admin_Under_Workroom_Member = By.xpath(
			"//div[starts-with(@id,'collapseWorkroomSettings_')]//div[@class='row bordered']//div[@class='col-sm-12 panel-section-heading'][contains(text(),'Workroom Members')]/following::tr[ starts-with(@id,'settings-users-info-')]/td[2]/a");
