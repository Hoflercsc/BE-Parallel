...
public class BookScannedPDFPage {
	...
	public void click_Library() {
		...
		WebElement foo = driver.findElement(By.xpath("//span[contains(text(),'Library')]"));
	...
	// ----------------------------build_Book()---------------------------------------
	// By build_Handbook = By.xpath("//a[@class='primary-action-btn btn-sidebar
	// be-blue'][contains(text(),'Build Book')]");
	...
	public void verify_Build_Book() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(30)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
	...
	public void click_Build_Book() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//a[@class='primary-action-btn btn-sidebar be-blue']"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	}
	...
	public void click_Build_DoneBtn() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//button[contains(text(),'Done')]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	}
	...
	// --------------------------make_Book_Visible----------------------------------
	// By edit_BookBtn = By.xpath("//a[@class='primary-action-btn btn-sidebar
	// be-blue'][contains(text(),'Edit Book')]");
	By edit_BookBtn = By.xpath("//a[@class='primary-action-btn btn-sidebar be-blue']");
	...
	public void click_On_Switch() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//label[@class='onoffswitch-label']"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	}
	...
	public void click_Workroom_Library_Crumb() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//a[contains(text(),'Workroom Library')]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	}
	...
	// ------------------Edit Handbook---------------------------------
	By scanned_Book_Dropdown = By.xpath("//*[starts-with (@id,'card-')]/div[2]/div[1]/h3/a/following::div[@class='dropdown header-actions']");
	...
	By edited_Scanbook_Visible = By.xpath("//a[contains(text(),'This is an Edited Scanned Book')]");
	...
	public void click_Scanned_Book_Dropdown() throws InterruptedException {
		...
		// WebElement foo = driver.findElement(By.xpath("//div[@class='dropdown
		// header-actions']"));
		// JavascriptExecutor executor = (JavascriptExecutor)driver;
		// executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	...
	public void click_Edit_Option() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//ul[@class='dropdown-menu']//a[contains(text(),'Edit')]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	}
	...
	// By thumbnail =
	// By.xpath("//body/div[@id='app']/div[contains(@class,'App')]/div[contains(@class,'Panel
	// LeftPanel
	// open')]/div[contains(@class,'left-panel-header')]/div[contains(@class,'LeftPanelTabs')]/div[1]");
	By thumbnail = By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[1]/div[2]/div[1]");
	...
	public void click_Edited_Scanned_Book_Title() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//*[contains(text(),'This is an Edited Scanned Book')]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
		Thread.sleep(1000);
	}
	...
	public void click_Meeting_Book_Viewer() throws InterruptedException {
		...
		WebElement foo = driver.findElement(By.xpath("//div[@class='sidebar-fixed-container']//a[@id='view_book']"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", foo);
	}
	...
	public void switch_Tab_Scroll_Scanned_Book() throws InterruptedException {
		...
		// WebElement iframe= driver.findElement(By.xpath("//*[@id=\"ebf0\"]"));
		driver.switchTo().frame(iframe);
		WebElement iframeThumbnail = driver.findElement(thumbnail);
		// waiting for thumbnails to be visible
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
	...
	public void user_Opens_Meeting_Book_Viewer_And_Scroll() throws InterruptedException {
		...
		/*
		 * this.click_Meeting_Book_Viewer(); Thread.sleep(3000);
	...
	public void click_ContinueBtn() throws InterruptedException {
		...
		WebElement del = driver.findElement(By.xpath("//button[@class='btn commit btn-danger'][contains(text(),'Continue')]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", del);
		Thread.sleep(1000);
	}
