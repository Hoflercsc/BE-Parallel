...
public class PollPage {
	...
	//By pollsSubMenu = By.xpath("id(\"wrap\")/main[1]/div[1]/div[2]/div[1]/div[2]/div[1]/span[2]/a[1]");
    //By pollsSubMenu = By.xpath("//*[@id=\"wrap\"]/main/div[1]/div[2]/div/div[2]/div[3]/span[2]/a");
    By pollsSubMenu = By.xpath("//a[contains(text(),'Polls')]");
	...
	By pollSucessMessage = By
			.xpath("//div[@class='col-md-10 narrow meeting-details']//div//p[contains(text(),'Successfully created This is a Poll Title')]");
	// By newQuestionOne = By.xpath("(//a[contains(text(),'what is your favorite
	// food?')])[1]");
	By newQuestionOne = By.xpath("//div[starts-with(@id,'survey_')]/div[1]/a[1]");
	By newQuestionOneB = By.xpath("(//a[contains(text(),'what is your favorite food?')])[1]");
	...
	By pollSucessResponseMessage = By
			.xpath("//div[@class='col-md-10 narrow meeting-details']//div//p[contains(text(),'Successfully responded to poll: This is a Poll Tit')]");
	...
	public void verifyNewQuestionOneB() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(newQuestionOneB)));
	}
...
//		this.clickContinueBtn();
	...
	public void verify_Poll_NOT_Exist() throws InterruptedException {
		Thread.sleep(2000);
		String poll = "//*[starts-with (@id,'survey-card-')]/div/div[1]/h3/a";
