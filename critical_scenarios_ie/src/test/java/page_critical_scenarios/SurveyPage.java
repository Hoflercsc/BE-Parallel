...
public class SurveyPage {
	...
	By newSurveyBtn = By.xpath("//a[@class='btn btn-success'][contains(text(),'New Survey')]");
	...
	By surveySucessMessage = By.xpath("//div[@class='col-md-10 narrow meeting-details']//div//p[contains(text(),'Successfully created This is a Survey Title')]");
	// ---Text Field Question ----------
	...
	By surveySucessResponseMessage = By.xpath(
			"//div[@class='col-md-10 narrow meeting-details']//div//p[contains(text(),'Successfully responded to survey: This is a Survey Title')]");
	...
	public void clickSurveys() {
		...
		WebElement element = driver.findElement(By.xpath("//span[@class='label label-default']//a[contains(text(),'Surveys')]"));
	...
	public void clickNewSurveyBtn() {
        ...
        .until((WebDriver d) -> {
            d.findElement(By.xpath("//a[@class='btn btn-success'][contains(text(),'New Survey')]")).click();
            return true;
        });
	...
	public void clickQuestionOne() {
		...
		WebElement element = driver.findElement(By.xpath("(//a[contains(text(),'Add Question')])[1]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element);
	}
