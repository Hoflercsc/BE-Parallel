...
public class RunAttendanceReport extends BaseTestCriticalScenarios {
	...
	public void user_Opens_Settings_Form_Open_Reports() throws InterruptedException {
		...
		objectAttdReport.user_Opens_Settings_Form_Open_Reports();
	}
	...
	@Test(priority = 5, description = "user_Generate_And_Download_PDF_Report")
	...
	// @Test(priority = 6, description = "user_Generate_And_Download_Excel_Report")
	// public void user_Generate_And_Download_Excel_Report() throws
