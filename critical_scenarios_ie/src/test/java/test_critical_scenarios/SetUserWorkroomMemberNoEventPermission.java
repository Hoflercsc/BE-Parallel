...
public class SetUserWorkroomMemberNoEventPermission extends BaseTestCriticalScenarios {
	...
	@Test(priority = 17, description = "systemAdmin_Open_Settings_Then_Workroom_And_Group_Settings_3rd_Time")
	...
	@Test(priority = 18, description = "systemAdmin_Set_User_As_Workroom_Admin")
	...
	@Test(priority = 19, description = "systemAdmin_Close_And_Logout_2nd_Time")
	...
	@Test(priority = 20, description = "workroom_Member_Login_To_BoardEffect_3rd_Time")
	...
	@Test(priority = 21, description = "workroom_Member_Open_Library_For_Workroom_Has_New_Book_Button")
	...
	@Test(priority = 22, description = "workroom_Member_Can_Logout_3rd_Time")
	...
	@Test(priority = 23, description = "systemAdmin_Can_Login_To_BoardEffect_4th_Time")
	...
	@Test(priority = 24, description = "systemAdmin_Open_Settings_Then_Workroom_And_Group_Settings_4th_Time")
	...
	@Test(priority = 25, description = "systemAdmin_Set_User_As_Workroom_Member")
