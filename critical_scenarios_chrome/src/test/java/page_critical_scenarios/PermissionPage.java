...
public class PermissionPage {
	...
	public void verify_Events() throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("//body/div[@id='profileModal']//div/form//div/a[contains(text(),'AutoBE')]"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);
	}
	...
	public void verify_Events_C() throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("//div[@id='profileModal']//div/form//a[contains(.,'AutoBE')]"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);
	}
	...
	public void verify_Workroom_Admin_Eng_Dropdown() throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("(//table[@class='modal-table-list']//tbody//a[contains(text(),'workroom admineng')]/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);
	}
	
	public void click_Workroom_Admin_Eng_Dropdown() throws InterruptedException {
		WebElement element = driver.findElement(By.xpath("(//a[contains(text(),'workroom admineng')]/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1000);
		// driver.findElement(workroom_Admin_Dropdown).click();
		WebElement element2 = driver.findElement(By.xpath("(//a[contains(text(),'workroom admineng')]/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element2);
	}
	...
	public void click_Events_C() throws InterruptedException {
		WebElement element = driver.findElement(By.xpath("//input[@id='can_access_events_3052']"));
	...
	public void workroom_Member_Sees_Event_Due_To_Permissions() throws InterruptedException {
		...
		System.out.println("------- Completed --> workroom_Member_Sees_Event_Due_To_Permissions() -----------");
	}
	...
	public void systemAdmin_Set_User_As_Workroom_Admin_2() throws InterruptedException {
		this.verify_AutoBE_Expand();
		this.click_AutoBE_Expand();
		Thread.sleep(2000);
	...
	public void systemAdmin_Set_User_As_Workroom_Member_Eng() throws InterruptedException {
		this.click_AutoBE_Expand();
		Thread.sleep(2000);
