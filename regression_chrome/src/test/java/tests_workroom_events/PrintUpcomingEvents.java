...
public class PrintUpcomingEvents extends BaseTestWorkroomEvents {
	...
	@Test(priority = 6, description = "user_Delete_Print_Upcoming_Event_1")
	public void user_Delete_Print_Upcoming_Event_1() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Print-Upcoming-Events");
	...
	public void user_Delete_Print_Upcoming_Event_2() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Print-Upcoming-Events");
