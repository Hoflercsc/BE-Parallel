...
public class TakeEventAttendance extends BaseTestWorkroomEvents {
	...
	@Test(priority = 13, description = "autoUser_Take_Attendance")
	public void autoUser_Take_Attendance() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Take-Event-Attendance-Report");
		
		objectEvent = new EventPage(driver);
		objectEvent.autoUser_Take_Attendance();
	}
	
	@Test(priority = 14, description = "generate_Attendance_Report")
	...
	@Test(priority = 15, description = "user_Can_Delete_Event_And_Verify_Deleted")
