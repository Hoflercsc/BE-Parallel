...
public class CopyLinkOnFileFromViewOnlyFolder extends BaseTestResourceLibrary {	
	...
	@Test(priority = 10, description = "copy_File_Link")
	...
	@Test(priority = 11, description = "open_File_Link")
	...
	@Test(priority = 12, description = "switch_Tab_Verify_Viewer_Element")
	...
	@Test(priority = 14, description = "user_Can_Delete_View_Only_Folder")
