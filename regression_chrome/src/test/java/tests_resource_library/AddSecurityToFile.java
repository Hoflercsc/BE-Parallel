...
public class AddSecurityToFile extends BaseTestResourceLibrary {
	...
	@Test(priority = 10, description = "user_Can_Open_Libraries_In_AutoDirector")
	...
	@Test(priority = 11, description = "user_Can_Add_File_To_2nd_Folder")
	...
	@Test(priority = 15, description = "user_Delete_Folder_2")
	...
	@Test(priority = 16, description = "user_Close_Library_Folder_2nd_Time")
