...
public class NavigateToTakeMinutesViaHandbook extends BaseTestWorkroomLibrary {
	...
	@Test(priority = 11, description = "open_Handbook_Navigate_To_Take_Minutes")
	public void open_Handbook_Navigate_To_Take_Minutes() throws InterruptedException, AWTException {
		test.assignCategory("Workroom-Library >> Navigate-To-Minutes-Via-Handbook");
		
		obj_meeting_book = new BookPage(driver);
		obj_meeting_book.open_Handbook_Navigate_To_Take_Minutes();
	}
	...
	public void delete_Handbook() throws InterruptedException {
		...
		Thread.sleep(1000);
		obj_meeting_book.verify_Handbook_Title();
