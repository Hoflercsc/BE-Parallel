...
//		driver.findElement(title).clear();
	...
	By role_Tag_2 = By.xpath("//body/div[@id='clientLookFeel']//form[1]//div[10]//span[6][contains(.,'Role')]");

	By plus_Sign = By.xpath("//body/div[@id='clientLookFeel']//form[1]/div[9]//i[@class='fa fa-plus-circle fa-2x']");
	By plus_Sign_2 = By.xpath("//body/div[@id='clientLookFeel']//form[1]/div[10]//i[@class='fa fa-plus-circle fa-2x']");
...
//		executor.executeScript("arguments[0].click();", element);
	...
	public void remove_Print_Logo() {
		WebElement box = driver.findElement(By.xpath("//label[contains(text(),'Remove Print Logo')]"));
