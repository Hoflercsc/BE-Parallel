...
public class BookScannedPDFPage {
	...
	By scanned_Book_Title = By.xpath("//a[contains(text(),'This is a Scanned Book')]");

	public void click_Scanned_Book_Title() throws InterruptedException {
		driver.findElement(scanned_Book_Title).click();
	}
	
	public void contributor_User_Can_Add_Files() throws InterruptedException {
		this.verify_Scanned_Book_Visible();
		this.click_Scanned_Book_Title();
		System.out.println("------- Completed --> contributor_User_Can_Add_Files()  -----------");
	}
...
//		Thread.sleep(1500);
	...
	By minutes_Image = By.xpath("//img[@id='thumb2']");
