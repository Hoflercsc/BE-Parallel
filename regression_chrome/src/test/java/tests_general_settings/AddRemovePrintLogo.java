...
public class AddRemovePrintLogo extends BaseTestGeneralSettings {
	...
	@Test(priority = 16, description = "verify_Book_Deleted")
	...
	@Test(priority = 17, description = "user_Can_Open_Settings_2nd_Time")
	...
	@Test(priority = 18, description = "navigate_To_General_Look_Feel_2nd_Time")
	...
	@Test(priority = 19, description = "disable_Print_Logo")
	...
	@Test(priority = 20, description = "verify_Logo_Removed")
	public void verify_Logo_Removed() throws InterruptedException {
		...
		obj_navigation.user_Can_Open_Settings();
		obj_general_settings.navigate_To_General_Look_Feel();
		obj_general_settings.verify_Logo_Removed();
	}
