...
public class AnnouncekitPage {
	...
	By whats_New = By.xpath("//span[contains(text(),\"What's New\")]");
	By iframe_CloseBtn = By.xpath("//*[@id=\"widget\"]/div/header/h1/div");
	By autoBE = By.xpath("//a[contains(text(),'AutoBE')]");
	By workroom_Side_Nav = By.xpath("//body/div[@id='wrap']/main//div/ul[@class='workroom-nav']");
	...
	public void verify_Whats_New_Modal_And_Scroll() throws InterruptedException {
		...
		WebElement iframeSection = driver.findElement(By.xpath("//*[@id='widget']//div/section//h1[contains(.,'New Board Orientation video')]"));
