...
public class RemoveAttachedBookFromEvent extends BaseTestWorkroomEvents {
	...
	@Test(priority = 15, description = "remove_Attached_Book_From_Event")
	public void remove_Attached_Book_From_Event() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
		
		objectEvent = new EventPage(driver);
		objectEvent.remove_Attached_Book_From_Event();
	}

	@Test(priority = 16, description = "delete_Event")
	...
	@Test(priority = 17, description = "verify_Event_Deleted")
	...
	@Test(priority = 19, description = "delete_Book")
