...
public class PermissionsPage {
	...
	By meetig_Book_Viewer = By.xpath("//div[@class='atlas-books-sidebar col-md-2']//a[@id='view_book']");
	...
	public void verify_Test_User_Hidden() {
		String test_Reset = "(//*[normalize-space(text())='Test Reset']/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]";
	...
	*/
	...
	By test_User = By.xpath("//*[normalize-space(text())='Test Reset']");
	...
	public void check_Workroom_Admin_Not_Visible() throws InterruptedException {
		String element = "//*[normalize-space(text())= 'Workroom Admin']";
		Assert.assertTrue(driver.findElements(By.xpath(element)).size() < 1);
	}
	...
	public void click_Auto_Director_Dropdown_2() {
		// driver.findElement(workroom_Admin).click();
		WebElement element2 = driver.findElement(By.xpath("(//tbody/tr[starts-with(@id,'settings-users-info-')]//a[normalize-space(text())='Auto Director']/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element2);
	}
	...
	public void verify_AutoBE_Workroom_Users() throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath(moreBtn));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
		Thread.sleep(1500);
		driver.findElement(By.xpath(moreBtn)).click();
		Thread.sleep(2000);
		WebElement element2 = driver.findElement(By.xpath(auto_User3));
