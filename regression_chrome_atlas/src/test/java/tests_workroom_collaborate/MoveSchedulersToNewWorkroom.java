...
public class MoveSchedulersToNewWorkroom extends BaseTestWorkroomCollaborate {
	...
	@Test(priority = 7, description = "verify_Move_Scheduler_To_Workroom_AutoAttend")
	public void verify_Move_Scheduler_To_Workroom_AutoAttend() throws InterruptedException {
		test.assignCategory("Workroom Collaborate >> Move-Schedulers-To-New-Workroom");
		
		objCreateSurvey = new SurveyPage(driver);
		objCreateSurvey.verify_Move_Scheduler_To_Workroom_AutoAttend();
	}
	...
	@Test(priority = 9, description = "verify_Schedulers_Deleted")
