...
public class DownloadSummarySurveyPDF extends BaseTestWorkroomCollaborate {
	...
	@Test(priority = 5, description = "download_Survey_As_PDF")
	public void download_Survey_As_PDF() throws InterruptedException {
		test.assignCategory("Workroom Collaborate >> Download-Summary-Survey-PDF");
		
		objCreateSurvey = new SurveyPage(driver);
		objCreateSurvey.download_Survey_As_PDF();
	}
