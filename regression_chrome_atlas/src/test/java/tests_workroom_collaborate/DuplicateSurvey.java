...
public class DuplicateSurvey extends BaseTestWorkroomCollaborate {
	...
	@Test(priority = 9, description = "duplicate_Survey")
	public void duplicate_Survey() throws InterruptedException {
		test.assignCategory("Workroom Collaborate >> Duplicate-Survey");
		
		objCreateSurvey = new SurveyPage(driver);
		objCreateSurvey.duplicate_Survey();
	}
	...
	@Test(priority = 11, description = "build_Survey_Make_Visible_Agian")
	public void delete_Both_Surveys() throws InterruptedException {
		test.assignCategory("Workroom Collaborate >> Duplicate-Survey");
