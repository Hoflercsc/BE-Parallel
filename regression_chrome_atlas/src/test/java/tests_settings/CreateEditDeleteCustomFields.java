...
public class CreateEditDeleteCustomFields extends BaseTestSettings {
	
	//-----------set_workroom_to_view_only-------------------------
	@Test(priority = 1, description = "Login System Admin UserName Password.")
	public void systemAdmin_login() throws InterruptedException {
		test.assignCategory("Settings >> Create-Edit-Delete-Custom-Fields");
	...
	@Test(priority = 5, description = "edit_Custom_Field_Group")
	...
	@Test(priority = 7, description = "delete_Custom_Field_Group")
	...
	@Test(priority = 9, description = "verify_Custom_Field_Group_Deleted")
