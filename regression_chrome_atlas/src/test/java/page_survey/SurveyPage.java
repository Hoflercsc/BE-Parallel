...
//		this.clickContinueBtn();
	...
	public void attach_Event_To_Scheduler() throws InterruptedException {
		...
		System.out.println("------- Completed --> attach_Event_To_Scheduler() -----------");
	}
	...
	public void verify_Move_Scheduler_To_Workroom_AutoAttend() throws InterruptedException {
		//this.verify_AutoAttend_Workroom();
		//this.click_AutoAttend_2();
		//Thread.sleep(1000);
		AtlasNavBar obj  = new AtlasNavBar(driver);
	...
	By settings_2 = By.xpath("//div[@class='dropdown header-actions open']//a[contains(text(),'Settings')]");
	...
	public void click_Settings_2() throws InterruptedException {
		driver.findElement(settings_2).click();
	}
	...
	public void click_Delete_Option() throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("//div[@class='dropdown header-actions open']//a[contains(text(),'Delete')]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element);
	}
	...
	By templateSucessMessage = By.xpath("//p[contains(text(),'Successfully created Survey Template Title')]");
	...
	By schedulers_Title_Copy_Dropdown = By.xpath("(//a[contains(text(),'This is a Schedulers Title - Copy')]/following::div[@class='dropdown header-actions'])[1]");
	...
	public void verifyCopyOfSchedulersTitleDropDown() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
	...
	public void click_Schedulers_Title_Copy_Dropdown() {
		driver.findElement(schedulers_Title_Copy_Dropdown).click();
	}
	...
	public void build_Schedulers_Make_Visible() throws InterruptedException {
		...
		Thread.sleep(1000);
		this.verifySubmitBtn();
		this.clickSurveyBtnOn();		Thread.sleep(1000);
		this.clickBreadCrumbScheduler();
		Thread.sleep(1000);
		this.verifySchedulersTitleDropDown();
	...
	public void build_Schedulers_Make_Visible_2() throws InterruptedException {
		this.clickBuildBtn();
		Thread.sleep(1000);
		this.verifySubmitBtn();
		this.clickSurveyBtnOn();
		...
		this.clickBreadCrumbScheduler();
		Thread.sleep(1000);
		this.verifyCopyOfSchedulersTitleDropDown();
		System.out.println("------- Completed --> build_Schedulers_Make_Visible_2() -----------");
	}
	...
	public void verify_Archived_Schedulers() throws InterruptedException {
		String element = "(//a[contains(text(),'This is a Schedulers Title')]/following::button[@id='dropdownMenu1'])[1]";
		Assert.assertTrue(driver.findElements(By.xpath(element)).size() > 0);
	}
	
	public void archive_Schedulers() throws InterruptedException {
		this.click_Schedulers_Title_Dropdown();
		Thread.sleep(1000);
		this.verifiy_Results();
		this.clickArchive();
		Thread.sleep(1000);
		this.verifyArchiveCard();
		this.verify_Archived_Schedulers();
	...
	public void verify_Schedulers_Settings() {
		...
		Assert.assertTrue(driver.findElements(By.xpath(description)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(notify)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(box1)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(box2)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(box3)).size() > 0);
	...
	public void click_Blue_Light_Bulb() {
		driver.findElement(blue_Light_Bulb).click();
	}
	...
	public void click_Expanded_Default_View() {
		driver.findElement(expanded_default_View).click();
	}
	...
	public void verify_Expanded_View_Schedulers() throws InterruptedException {
		...
		Assert.assertTrue(driver.findElements(By.xpath(scheduler1)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(scheduler2)).size() > 0);
	}
	...
	public void verify_Tile_View_Schedulers() throws InterruptedException {
		...
		Assert.assertTrue(driver.findElements(By.xpath(tab_List_View)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(scheduler1)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(scheduler2)).size() > 0);
	}
	...
	public void verify_Scheduler_Deleted() throws InterruptedException {
		String element = "(//a[contains(text(),'This is a Schedulers Title')]/following::div[@class='dropdown header-actions'])[1]";
		Assert.assertTrue(driver.findElements(By.xpath(element)).size() < 1);
	}
	
	public void delete_Schedulers_2() throws InterruptedException {
		this.verifySchedulersTitleDropDown();
		this.click_Schedulers_Title_Dropdown();
		Thread.sleep(1000);
		this.verify_Delete_Option();
		...
		driver.navigate().refresh();
		Thread.sleep(1000);
		System.out.println("------- Completed --> delete_Scheduler_2() -----------");
	}
