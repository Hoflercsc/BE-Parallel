...
public class DirectoryPage {
	...
	public void click_Officer_Role_DrpDwn() {
		...
		WebElement role = driver.findElement(By.xpath("(//body//div[@id='directoryModal']//div//label[contains(text(),'Officer Role')]/following::button)[1]"));
	...
	public void verify_Only_Board_Members_Shown() {
		...
		Assert.assertTrue(driver.findElements(By.xpath(auto_Director2)).size() > 0);
		Assert.assertTrue(driver.findElements(By.xpath(workroom_Admin)).size() < 1);
		Assert.assertTrue(driver.findElements(By.xpath(steve_System)).size() < 1);
	}
	// ------------------ Function Being Called ----------------------
	...
	public void click_Angel_Morgan_DrpDwn() throws InterruptedException {
		WebElement SaveBtn = driver.findElement(angel_Morgan_DrpDwn);
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", SaveBtn);
		Thread.sleep(1500);
		
		WebElement element = driver.findElement(angel_Morgan_DrpDwn);
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element);
	...
	public void populate_Multiple_User_Form() throws InterruptedException {
		...
		String login = "aMoore1";
		String email_1 = "aMoore1@gmail.com";
		//------------------------------------------------------
		...
		driver.findElement(login_1).clear();
		driver.findElement(login_1).sendKeys(login);
	...
	public void verify_Board_Member_B() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(board_Member_B)));
	}
	
	public void verify_Board_Member_C() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(board_Member_C)));
	}
	...
	public void verify_AutoBE_WR_B() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(autoBE_WR_B)));
	}
	...
	public void click_Board_Member_B() {
		driver.findElement(board_Member_B).click();
	}
	
	public void click_Board_Member_C() {
		driver.findElement(board_Member_C).click();
	}
	...
	public void click_AutoBE_WR_B() {
		driver.findElement(autoBE_WR_B).click();
	}
	
	public void click_Workrooms_Tab_B() {
		driver.findElement(workroom_Tab_B).click();
	}
	...
	By email_2 = By.xpath("//*[contains(text(),'You will')]");
	...
	public void verify_Success_Message_Email_1() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(email_1)));
	}
	...
	public void scroll_To_Sucess_Message_Container() throws InterruptedException {
		WebElement success = driver.findElement(email_2);
	...
	public void verify_Company_Contact_Info_Not_Present() {
		...
		Assert.assertTrue(driver.findElements(By.xpath(company_Contact_Info)).size() < 1);
	}
	...
	public void verify_AutoTester_Hidden() {
		String autoTester = "(//*[normalize-space(text())='Automation Tester']/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]";
		Assert.assertTrue(driver.findElements(By.xpath(autoTester)).size() < 1);
	}
	
	public void verify_Test_Reset_Hidden() {
		String autoTester = "(//*[normalize-space(text())='Test Reset']/following::button[@class='btn btn-default btn-xs dropdown-toggle'])[1]";
		Assert.assertTrue(driver.findElements(By.xpath(autoTester)).size() < 1);
	}
