...
public class EventPage {
	...
	public void new_Event_Form_Populate() throws InterruptedException {
		...
		//----------
		if(driver.getCurrentUrl().contains("lab")) {
			this.labFormCalendarUpComingDate();
		}else {
		  this.formCalendarUpComingDate();
		}
		
		Select country = new Select(driver.findElement(By.xpath("//select[@id='event_country']")));
		country.selectByVisibleText("United States");
		Thread.sleep(1000);

		Select state = new Select(driver.findElement(By.xpath("//select[@id='event_state']")));
		state.selectByVisibleText("Virginia");
		Thread.sleep(1000);

		driver.findElement(By.xpath("//input[@id='event_zip']")).sendKeys("23513");
	...
	public void new_Event_Attendance_Virtual() throws InterruptedException {
		String location = "Chralott, NC";
		...
		//---Attendance Type -------------
		Select attendanceDropdown = new Select(driver.findElement(By.xpath("//select[@id='event_meeting_type']")));
	...
	public void new_Event_Attendance_Hybrid() throws InterruptedException {
		String location = "Chralott, NC";
		String description_Box = "This Is A Virtual Event being created";
		String url ="https://hoflercsc.my.webex.com";
		String email = "jhofler@diligent.com";
...
//		Thread.sleep(1000);
	...
	public void user_Can_Create_New_Event_Virtual() throws InterruptedException {
		this.click_New_Event_Btn();
		this.verify_Form_Title();
		this.new_Event_Attendance_Virtual();
		this.click_Form_SaveBtn_Top();
		Thread.sleep(1500);
		this.verify_Event_Success_Message();
		this.scroll_Down_To_SaveBtn();
	...
	public void user_Can_Create_New_Event_Hybrid() throws InterruptedException {
		this.click_New_Event_Btn();
		this.verify_Form_Title();
		this.new_Event_Attendance_Hybrid();
		this.click_Form_SaveBtn_Top();
		Thread.sleep(1000);
		this.verify_Event_Success_Message();
		this.scroll_Down_To_SaveBtn();
	...
	By virtualBtn_Not_Active = By.xpath("//a[@class='btn btn-default remote'][contains(.,'Virtual')]");
	By virtualBtn_Active = By.xpath("//a[@class='btn btn-default remote active'][contains(.,'Virtual')]");
	By inPersonBtn_Not_Active = By.xpath("//a[@class='btn btn-default accept'][contains(.,'In Person')]");
	By inPersonBtn_Active = By.xpath("//a[@class='btn btn-default accept active'][contains(.,'In Person')]");
	...
	public void verify_VirtualBtn_Not_Active() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(10)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(virtualBtn_Not_Active)));
	}
	
	public void verify_VirtualBtn_Active() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(10)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(virtualBtn_Active)));
	}
	
	public void verify_InPersonBtn_Not_Active() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(10)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(inPersonBtn_Not_Active)));
	}
	
	public void verify_InPersonBtn_Active() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(10)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(inPersonBtn_Active)));
	}
	...
	public void click_VirtualBtn_Not_Active() throws InterruptedException {
		driver.findElement(virtualBtn_Not_Active).click();
	}
	
	public void click_InPersonBtn_Not_Active() throws InterruptedException {
		driver.findElement(inPersonBtn_Not_Active).click();
	}
	...
	public void autoDirector_Response_Vitual() throws InterruptedException {
		AtlasNavBar obj  = new AtlasNavBar(driver);
		obj.workroom_Member_Open_Workroom_AutoBE();
		this.verify_VirtualBtn_Not_Active();
		Thread.sleep(1000);
		this.click_VirtualBtn_Not_Active();
		Thread.sleep(1500);
		this.verify_VirtualBtn_Active();
		System.out.println("------- Completed --> autoDirector_Response_Vitual() -----------");
	}
	...
	public void testUser_Response_InPerson() throws InterruptedException {
		AtlasNavBar obj  = new AtlasNavBar(driver);
		obj.workroom_Member_Open_Workroom_AutoBE();
		this.verify_InPersonBtn_Not_Active();
		Thread.sleep(1000);
		this.click_InPersonBtn_Not_Active();
		Thread.sleep(1500);
		this.verify_InPersonBtn_Active();
		System.out.println("------- Completed --> testUser_Response_InPerson() -----------");
	}
	...
	public void verify_Scheduler_Button_Displayed() throws InterruptedException {
		String element = "//a[@class='btn btn-default'][contains(text(),'Scheduler')]";
		Assert.assertTrue(driver.findElements(By.xpath(element)).size() > 0);
	}
	...
	public void verify_User_Response_To_Virtual_Event() throws InterruptedException {
		...
		this.click_Event_Title_2();
		Thread.sleep(1000);
		//this.verify_To_Attach_Or_Create();
		this.verify_Guest_List_And_Scroll();
		this.verify_AutoDirector_Virtualy_Attending();
		this.click_Events_Menus2();
		Thread.sleep(1000);
		System.out.println("------- Completed --> verify_User_Response_To_Virtual_Event() -----------");
	}
	
	public void verify_AutoDirector_TestUser_Response() throws InterruptedException {
		this.verify_Event_Title_2();
		this.click_Event_Title_2();
		Thread.sleep(1000);
		this.verify_Guest_List_And_Scroll();
		this.verify_AutoDirector_Virtualy_Attending();
		this.verify_WorkroomAdmin_InPerson_Attending();
		Thread.sleep(1000);
		this.click_Events_Menus2();
		System.out.println("------- Completed --> verify_AutoDirector_TestUser_Response() -----------");
	}
	...
	public void verify_AutoDirector_Virtualy_Attending() throws InterruptedException {
		String user = "//th[contains(.,'Attending - Virtual')]/following::td/span[contains(.,'Auto Director')]";
		Assert.assertTrue(driver.findElements(By.xpath(user)).size() > 0);
	}
	
	public void verify_WorkroomAdmin_InPerson_Attending() throws InterruptedException {
		String user = "//th[contains(.,'Attending - In Person')]/following::td/span[contains(.,'Workroom Admin')]";
		Assert.assertTrue(driver.findElements(By.xpath(user)).size() > 0);
	}
