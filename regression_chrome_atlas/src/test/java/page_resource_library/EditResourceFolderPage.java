...
public class EditResourceFolderPage {
	...
	public void user_Actually_Edits_Library_Folder_2() throws InterruptedException {
		this.click_New_Folder_Dropdown_2();
		Thread.sleep(1500);
		this.verify_Edit_Option();
		this.click_Edit_Option();
		Thread.sleep(1500);
	...
	public void verify_Folder_Name() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(edited_Folder_Name)));
	}
	...
	public void verify_New_Lib_Folder() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(new_Library_Folder)));
	}
	...
	public void create_New_Resource_Library_Folder() throws InterruptedException {
		...
		Thread.sleep(1500);
		driver.navigate().refresh();
		System.out.println("------- Completed --> create_New_Resource_Library_Folder() -----------");
	}
