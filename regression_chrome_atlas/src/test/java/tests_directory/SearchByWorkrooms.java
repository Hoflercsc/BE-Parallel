...
public class SearchByWorkrooms extends BaseTestDirectory {
	...
	public void loginBE_SystemAdmin() throws InterruptedException {
		test.assignCategory("Directory >> Search-By-Workrooms");
	...
	@Test(priority = 3, description = "search_By_Workroom_AutoBE")
	public void search_By_Workroom_AutoBE() throws InterruptedException, AWTException {
		test.assignCategory("Directory >> Search-By-Workrooms");
		
		obj_directory = new DirectoryPage(driver);
		obj_directory.search_By_Workroom_AutoBE();
	}
	
	@Test(priority = 3, description = "verify_AutoBE_Workrooms_Shown")
	public void verify_AutoBE_Workrooms_Shown() throws InterruptedException, AWTException {
		test.assignCategory("Directory >> Search-By-Workrooms");
		
		obj_directory = new DirectoryPage(driver);
		obj_directory.verify_AutoBE_Workrooms_Shown();
	}
