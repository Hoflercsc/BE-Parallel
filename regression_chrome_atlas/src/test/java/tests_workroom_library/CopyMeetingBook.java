...
public class CopyMeetingBook extends BaseTestWorkroomLibrary {
	...
	@Test(priority = 11, description = "Workroom-Library >> Copy--Meeting-Book")
	public void copy_Meeting_Book() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage(driver);
		obj_meeting_book.copy_Meeting_Book();
	}
	
	@Test(priority = 12, description = "verify_Book_And_Copied_Book_Created")
	public void verify_Book_And_Copied_Book_Created() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage(driver);
		obj_meeting_book.verify_Copied_Archived_Meeting_Book_Created();
	}
	
	@Test(priority = 13, description = "delete_Archived_Meeting_Book")
	...
	@Test(priority = 14, description = "delete_Copied_Archived_Meeting_Book")
	...
	@Test(priority = 15, description = "verify_Meeting_Books_Deleted")
