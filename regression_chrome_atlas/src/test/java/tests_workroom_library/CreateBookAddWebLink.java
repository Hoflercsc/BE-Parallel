...
public class CreateBookAddWebLink extends BaseTestWorkroomLibrary {
	...
	public void switch_Tabs_To_Web_Site() throws InterruptedException {
		test.assignCategory("Workroom-Library >> switch_Tabs_To_Web_Site");
		
		obj_meeting_book = new BookPage(driver);
		obj_general_settings = new GeneralSettingsPage(driver);

		obj_meeting_book.scroll_And_Click_Link();
	...
	@Test(priority = 13, description = "verify_Meeting_Books_Deleted")
