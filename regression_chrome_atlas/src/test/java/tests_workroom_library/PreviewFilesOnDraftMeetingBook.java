...
public class PreviewFilesOnDraftMeetingBook extends BaseTestWorkroomLibrary {
	...
	public void navigate_To_Edit_Preview_File() throws InterruptedException {
		...
		objectScannedPDF = new BookScannedPDFPage(driver);
		objectScannedPDF.navigate_To_Edit_Status_Verify_Book_Draft();
		objectScannedPDF.preview_Files();
	}
	
	@Test(priority = 12, description = "delete_Scanned_Book")
	...
	@Test(priority = 13, description = "verify_Scanned_Book_Deleted")
