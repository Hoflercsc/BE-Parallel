...
public class AdvancedSearchByBookEventDate extends BaseTestWorkroomLibrary {
	
	@Test(priority = 0, description = "home_Page_Redirect")
	public void home_Page_Redirect() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Advanced-Search-By-Event-Date");
	...
	public void advanced_Search_Search_By_Book_Title_A() throws InterruptedException {
		...
		obj_meeting_book.advanced_Search_Search_By_Event_Date();
	}
	
	@Test(priority = 4, description = "verify_Only_Book_A_With_Event_Present")
	public void verify_Only_Book_A_With_Event_Present() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Advanced-Search-By-Event-Date");
		
		obj_meeting_book = new BookPage(driver);
		obj_meeting_book.verify_Only_Book_A_With_Event_Present();
