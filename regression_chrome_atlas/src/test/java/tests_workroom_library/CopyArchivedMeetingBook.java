...
public class CopyArchivedMeetingBook extends BaseTestWorkroomLibrary {
	...
	@Test(priority = 12, description = "Workroom-Library >> Copy-Archived-Meeting-Book")
	public void copy_Archived_Meeting_Book() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Archived-Meeting-Book");
		
		obj_meeting_book = new BookPage(driver);
		obj_meeting_book.copy_Archived_Meeting_Book();
	}
	...
	public void delete_Copied_Archived_Meeting_Book() throws InterruptedException {
		...
		obj_meeting_book = new BookPage(driver);
		obj_meeting_book.delete_Copied_Archived_Meeting_Book();
	}
