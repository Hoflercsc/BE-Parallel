...
public class CreateDeleteWorkroom extends BaseTestCriticalScenarios {
	...
	@Test(priority = 5, description = "user_Can_Delete_Workroom")
	...
	@Test(priority = 6, description = "user_Opens_Settings_Opens_Workroom_And_Group_Settings_2nd_Time")
	...
	@Test(priority = 6, description = "verify_Workroom_Deleted")
