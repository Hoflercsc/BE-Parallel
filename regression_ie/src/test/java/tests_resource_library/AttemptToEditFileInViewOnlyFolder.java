...
public class AttemptToEditFileInViewOnlyFolder extends BaseTestResourceLibrary {	
	...
	@Test(priority = 8, description = "user_Can_Edit_File")
	...
	@Test(priority = 10, description = "user_Can_Open_Libraries_Form_5th_Time")
	...
	@Test(priority = 12, description = "user_Can_Open_Libraries_Form_6th_Time")
