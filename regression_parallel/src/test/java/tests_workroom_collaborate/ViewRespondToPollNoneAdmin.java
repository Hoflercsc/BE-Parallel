...
public class ViewRespondToPollNoneAdmin extends BaseTestWorkroomCollaborate {
	...
	public void create_Poll() throws InterruptedException {
		...
		objCreatePoll.create_Poll(poll5);
	}
	...
	public void add_Poll_Respondents() throws InterruptedException {
		...
		objCreatePoll = new PollPage();
		objCreatePoll.manageRespondents_D();
	}
	...
	public void login_As_Automation_Tester() throws InterruptedException {
		...
		objBELogin = new LoginLogoutPage();
		objBELogin.login_BE(autoUser5, password);
	}
	
	@Test(priority = 8, description = "user_Navigates_To_Poll_5")
	public void user_Navigates_To_Poll_5() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> View-Respond-To-Poll-Non-Admin");
		
		objCreatePoll = new PollPage();
		objCreatePoll.user_Navigates_To_Poll_5();
	}
	
	@Test(priority = 9, description = "respond_To_Poll_5")
	public void respond_To_Poll_5() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> View-Respond-To-Poll-Non-Admin");
		
		objCreatePoll = new PollPage();
		objCreatePoll.respond_To_Poll_5();
	}
	...
	@Test(priority = 13, description = "view_Poll_5_Individual_Reponses")
	public void view_Poll_5_Individual_Reponses() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> View-Respond-To-Poll-Non-Admin");
		
		objCreatePoll = new PollPage();
		objCreatePoll.view_Poll_5_Individual_Reponses();
	}
	
	@Test(priority = 14, description = "delete_Poll_5")
	public void delete_Poll_5() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> View-Respond-To-Poll-Non-Admin");
		
		objCreatePoll = new PollPage();
		objCreatePoll.delete_Poll_5();
	}
	
	@Test(priority = 15, description = "verify_Poll_5_NOT_EXIST")
	public void verify_Poll_5_NOT_EXIST() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> View-Respond-To-Poll-Non-Admin");
		
		objCreatePoll = new PollPage();
		objCreatePoll.verify_Poll_5_NOT_EXIST();
	}
