...
public class ViewRespondToSurveyAsAdmin extends BaseTestWorkroomCollaborate {
	...
	public void create_Survey() throws InterruptedException {
		...
		objCreateSurvey.create_Survey_Additional_Options(survey17);
	}
	...
	public void add_Survey_Respondents() throws InterruptedException {
		...
		objCreateSurvey = new SurveyPage();
		Thread.sleep(1500);
		objCreateSurvey.clickManageRespondentsAddUserF();
	}
	...
	public void login_As_Automation_Tester() throws InterruptedException {
		...
		objBELogin = new LoginLogoutPage();
		objBELogin.login_BE(autoAdminUserGS12, password);
	}
	...
	public void user_Goes_To_Survey_17() throws InterruptedException {
		...
		objCreateSurvey = new SurveyPage();
		objCreateSurvey.user_Goes_To_Survey_17();
	}
	...
	public void view_Survey_Reponses() throws InterruptedException {
		...
		objCreateSurvey = new SurveyPage();
		objCreateSurvey.view_Survey_17_Responses();
	}
	...
	public void delete_Survey() throws InterruptedException {
		...
		objCreateSurvey = new SurveyPage();
		objCreateSurvey.delete_Survey_17();
	}
	
	@Test(priority = 15, description = "verify_Survey_17_Deleted")
	public void verify_Survey_17_Deleted() throws InterruptedException {
		test.assignCategory("Workroom Collaborate >> View-Respond-To-Survey-As-Admin");
		
		objCreateSurvey = new SurveyPage();
		objCreateSurvey.verify_Survey_17_Deleted();
	}
