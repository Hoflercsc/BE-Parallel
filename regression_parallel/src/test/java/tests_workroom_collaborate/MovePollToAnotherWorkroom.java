...
public class MovePollToAnotherWorkroom extends BaseTestWorkroomCollaborate {
	...
	public void create_Poll() throws InterruptedException {
		...
		objCreatePoll.create_Poll(poll3);
	}
	...
	@Test(priority = 6, description = "move_Poll_3_To_Another_Workroom")
	public void move_Poll_3_To_Another_Workroom() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> Move-Poll-To-Another_Workroom");
		
		objCreatePoll = new PollPage();
		objCreatePoll.move_Poll_3_To_Another_Workroom();
	}
	...
	@Test(priority = 8, description = "delete_Poll_3")
	public void delete_Poll_3() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> Move-Poll-To-Another_Workroom");
		
		objCreatePoll = new PollPage();
		objCreatePoll.delete_Poll_3();
	}
	
	@Test(priority = 9, description = "verify_Poll_3_NOT_EXIST")
	public void verify_Poll_3_NOT_EXIST() throws InterruptedException {
		test.assignCategory("Workroom-Collaborate >> Move-Poll-To-Another_Workroom");
		
		objCreatePoll = new PollPage();
		objCreatePoll.verify_Poll_3_NOT_EXIST();
	}
