...
public class DiscussionPage {
	...
	public void verify_New_Discussions_Btn() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
	...
	public void clickDiscussionSubMenu() {
		DriverFactory.getInstance().getDriver().findElement(discussionsSubMenu).click();
	}

	public void clickDiscussionSubMenu2() {
		DriverFactory.getInstance().getDriver().findElement(discussionsSubMenu2).click();
	}

	public void clickNewDiscussionBtn() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(newDiscussionBtn).click();
		Thread.sleep(3000);
	}

	public void clickFormtitleFieldSendKeysSave() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(formTitleField).click();
		Thread.sleep(1000);
		DriverFactory.getInstance().getDriver().findElement(formTitleField).sendKeys(formTitle);
	}

	public void clickFormtitleFieldSendKeysSave2() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(formTitleField).click();
		Thread.sleep(1000);
		DriverFactory.getInstance().getDriver().findElement(formTitleField).sendKeys(formTitle2);
	}

	public void clickFormtitleFieldSendKeysSave3() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(formTitleField).click();
		Thread.sleep(1000);
		DriverFactory.getInstance().getDriver().findElement(formTitleField).sendKeys(formTitle3);
	}

	public void clickUpcomingDiscussions() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(upcomingDiscussions).click();
		Thread.sleep(2000);
	}

	public void clickClosedDiscussions() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(closeDiscussions).click();
		Thread.sleep(2000);
	}
	...
	public void formCalendarOpenDate() throws InterruptedException {
		...
		DriverFactory.getInstance().getDriver().findElement(inputDiscussionStart).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(inputDiscussionStart).clear();
		DriverFactory.getInstance().getDriver().findElement(inputDiscussionStart).sendKeys(strDateOne);
		Thread.sleep(1000);
		// DriverFactory.getInstance().getDriver().findElement(inputDiscussionEnd).click();
		DriverFactory.getInstance().getDriver().findElement(inputDiscussionEnd).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(inputDiscussionEnd).clear();
		DriverFactory.getInstance().getDriver().findElement(inputDiscussionEnd).sendKeys(strDateTwo);
	}
	...
	public void startDateCalendarFuture() throws InterruptedException {
       ...
       //--logic 
		WebElement calendar = DriverFactory.getInstance().getDriver().findElement(By.xpath("(//div[@class='datepicker-days']//table[@class='table-condensed']//tbody)[1]"));
		...
		for (WebElement DATE : opt) {
			 ...
			 System.out.println(DAY);
			 	...
			 	if (todaysDate.equals("29") || todaysDate.equals("30") || todaysDate.equals("31"))  {
			 		DriverFactory.getInstance().getDriver().findElement(By.cssSelector("body > div.bootstrap-datetimepicker-widget.dropdown-menu.picker-open.bottom > ul > li.collapse.in > div > div.datepicker-days > table > thead > tr:nth-child(1) > th.next")).click();
					Thread.sleep(2000);
					
					WebElement calendarB = DriverFactory.getInstance().getDriver().findElement(By.xpath("(//div[@class='datepicker-days']//table[@class='table-condensed']//tbody)[1]"));
	...
	public void endDateCalendarFuture() throws InterruptedException {
		...
		for (WebElement DATE : opt) {
			 ...
			 System.out.println(DAY);
			 	...
			 	if (todaysDate.equals("29") || todaysDate.equals("30") || todaysDate.equals("31"))  {
			 		DriverFactory.getInstance().getDriver().findElement(By.xpath("/html/body/div[44]/ul/li[1]/div/div[1]/table/thead/tr[1]/th[3]")).click();
					Thread.sleep(2000);
					
					WebElement calendarB = DriverFactory.getInstance().getDriver().findElement(By.xpath("(//div[@class='datepicker-days']//table[@class='table-condensed']//tbody)[2]"));
					List<WebElement> optB = calendarB.findElements(By.tagName("td"));
					//List<String> dB = optB.stream().map(WebElement::getText).collect(Collectors.toList());		 
					//System.out.println(dB);
		...
		for (WebElement DATE : opt) {
			 ...
			 System.out.println(DAY);
			 	...
			 	if (DATE.getText().equals("1") || DATE.getText().equals("2") || DATE.getText().equals("3") || DATE.getText().equals("6"))  {
			 		...
			 		DriverFactory.getInstance().getDriver().findElement(By.cssSelector(leftCalendarArrow)).click();
					Thread.sleep(2000);
	...
	public void addDiscussionRoomUsers() throws InterruptedException {
		...
		boolean workroom_Admin = DriverFactory.getInstance().getDriver().findElements(By.xpath(WAspan)).size() != 0;
		boolean Auto_Director = DriverFactory.getInstance().getDriver().findElements(By.xpath(ADspan)).size() != 0;
		boolean Automation_Tester = DriverFactory.getInstance().getDriver().findElements(By.xpath(ATspan)).size() != 0;
		if (workroom_Admin == false) {
			DriverFactory.getInstance().getDriver().findElement(By.xpath(WAdiv)).click();
		}
		if (Auto_Director == false) {
			DriverFactory.getInstance().getDriver().findElement(By.xpath(ADdiv)).click();
		}
		if (Automation_Tester == false) {
			DriverFactory.getInstance().getDriver().findElement(By.xpath(ATspan)).click();
		}
	...
	public void verifyOpenDiscussionExist() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(discussion)).size() != 0);
		Thread.sleep(1000);
	}
	...
	public void user_Navigates_To_Discussions() throws InterruptedException {
		...
		this.verifyworkroomSubnav();
		this.clickDiscussionSubMenu();
		this.verify_New_Discussions_Btn();
		System.out.println("------- Completed --> user_Navigates_To_Discussions-----------");
	}
	...
	public void clickDiscussionTitle() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(discussionTitle).click();
		Thread.sleep(2000);
	}

	public void clickNewTopicBtn() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(newtopicBtn).click();
	}

	public void topicTitleAndBodySendKeys() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).clear();
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(newTopic);
		// switching to iframe
		WebElement iframe = DriverFactory.getInstance().getDriver().findElement(By.xpath("//iframe[@class='cke_wysiwyg_frame cke_reset']"));
		DriverFactory.getInstance().getDriver().switchTo().frame(iframe);
		// finding body of iframe and sending text to it
		...
		DriverFactory.getInstance().getDriver().switchTo().defaultContent();
		DriverFactory.getInstance().getDriver().findElement(topicSubmitBtn).click();
		Thread.sleep(2000);
	}

	public void clickTopicTitleHeading() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(topicTitle).click();
	}

	public void clickNewReplyBtn() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(newReplyBtn).click();
	}

	public void topicReplySendKeysAndAttach() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).clear();
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(newReply);
		// switching to iframe
		WebElement iframe = DriverFactory.getInstance().getDriver().findElement(By.xpath("//iframe[@class='cke_wysiwyg_frame cke_reset']"));
		DriverFactory.getInstance().getDriver().switchTo().frame(iframe);
		// finding body of iframe and sending text to it
	...
	public void verifyTopicReplyAndAttachmentExist() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(topicMessage)).size() > 0);
	...
	public void create_Open_Discussion_AssignUsers() throws InterruptedException {
		...
		//this.startDateCalendarOpen();
		//this.endDateCalendarOpen();
		this.discussionDescriptionTextBox();
		this.saveBtn();
		this.verifyAddUsersSearchField();
		this.addDiscussionRoomUsers();
	...
	public void clickTopicsReplies() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(topicsReplies).click();
		Thread.sleep(2000);
	}

	public void searchForReply() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(search).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(search).clear();
		DriverFactory.getInstance().getDriver().findElement(search).sendKeys(replyMessage);
		Thread.sleep(3000);
	}
	...
	public void verifyReplyMessageExist() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(replyMessage)).size() > 0);
		Thread.sleep(1000);
	}
	...
	public void clickTopicArrow() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(topicArrow).click();
	}
	...
	public void editTopicTitleAndSave() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).clear();
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys("This is a New Topic 4 Me Someone");
		// switching to iframe
		WebElement iframe = DriverFactory.getInstance().getDriver().findElement(By.xpath("//iframe[@class='cke_wysiwyg_frame cke_reset']"));
		DriverFactory.getInstance().getDriver().switchTo().frame(iframe);
		// finding body of iframe and sending text to it
	...
	public void verifyDeletedTopicIsNotVisible() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(newTopic)).size() < 1);
	}
	...
	public void clickTopicArrowBtn() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(topicArrowBtn).click();
	}

	public void clickMySugestions() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(mySugestions).click();
	}

	public void topicReplySendKeysAndAttach2() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).clear();
		DriverFactory.getInstance().getDriver().findElement(inputTopicTitle).sendKeys(newReply2);
		// switching to iframe
		WebElement iframe = DriverFactory.getInstance().getDriver().findElement(By.xpath("//iframe[@class='cke_wysiwyg_frame cke_reset']"));
		DriverFactory.getInstance().getDriver().switchTo().frame(iframe);
		// finding body of iframe and sending text to it
	...
	public void verifyEditedTopicReplyMessageNOTExist() throws InterruptedException {
		...
		// Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(MySuggestions)).size() < 1);
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(editedreplyMessage)).size() < 1);
		Thread.sleep(1000);
	}
	...
	public void clickDropDownMenu() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(dropdownMenu).click();
	}
	...
	public void verifyDiscussionTitle() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(discussion)).size() != 0);
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(body)).size() != 0);
	}
	...
	public void clickArchiveDropDown() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(archiveDropDown).click();
	}

	public void clickRestoreOption() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(restore).click();
	}
	...
	public void click_Open_Discussions_Dropdown_Arrow() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(open_Discussion_Dropdown_Arrow).click();
	}

	// --upcoming
	public void click_Upcoming_Discussions_Dropdown_Arrow() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(upcoming_Discussion_Dropdown_Arrow).click();
	}

	// --closed
	public void click_Closed_Discussions_Dropdown_Arrow() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(closed_Discussion_Dropdown_Arrow).click();
	}
	...
	public void click_Open_Discussions() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(open_Discussions).click();
	}

	public void close_Open_Upcoming_Discussions() throws InterruptedException {
		// ------open discussions-------
	...
	By discussion_Title_1 = By.xpath("//h3//a[normalize-space(text())='Discussion 1']");
	By download_As_PDF_Btn = By.xpath("//*[@id='topiclist']//span/a[contains(.,'Download as PDF')]");
	By discussions_Bread_Crumb = By.xpath("//a[contains(text(),'Workroom Discussions')]");


	public void verify_Discussion_Title_1() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(discussion_Title_1)));
	}
	
	public void verify_Download_As_PDF_Btn() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(download_As_PDF_Btn)));
	}
	
	public void verify_Discussions_Bread_Crumb() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(discussions_Bread_Crumb)));
	}
	
	public void click_Discussion_Title_1() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(discussion_Title_1).click();
	}
	
	public void click_Download_As_PDF_Btn() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(download_As_PDF_Btn).click();
	}

	public void click_Discussions_Bread_Crumb() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(discussions_Bread_Crumb).click();
	}
	
	public void switch_Tab_View_PDF() throws InterruptedException {
		// ---switch to 2nd tab----
		...
		/*
		//-------------------
		String pdfdocument = "#content";
		//---click admin check box
		WebElement attachedElement = DriverFactory.getInstance().getDriver().findElement(By.tagName("pdf-viewer"));
		...
		WebElement pdf = shadowRoot1.findElement(By.cssSelector(pdfdocument));
		...
		Wait<WebDriver> wait2 = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait2.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(pdf)));
		//---------------------
		*/
	...
	public void download_Discussion_As_PDF() throws InterruptedException {
		this.verify_Discussion_Title_1();
		this.click_Discussion_Title_1();
		Thread.sleep(1000);
		this.verify_Download_As_PDF_Btn();
		this.click_Download_As_PDF_Btn();
		Thread.sleep(1000);
		this.switch_Tab_View_PDF();
		this.verify_Discussions_Bread_Crumb();
		this.click_Discussions_Bread_Crumb();
		Thread.sleep(1000);
		this.verify_Discussion_Title_1();
		System.out.println("------- Completed --> user_Navigates_To_Discussions-----------");
	}
