...
public class LibrariesPage {
	...
	public void click_New_Folder_Created() {
		...
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[contains(text(),'New Library Folder')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}

	public void click_More_Options() {
		DriverFactory.getInstance().getDriver().findElement(click_More_Options).click();
	}
	...
	public void add_File_Resource() {
		...
		DriverFactory.getInstance().getDriver().findElement(resource_Title).sendKeys(file_Title);
		DriverFactory.getInstance().getDriver().findElement(description).sendKeys(descrip);
	}
	...
	By resource_Dropdown = By.xpath(
			"//a[contains(text(),'steve System')]/following::td[@class='modal-cell dropdown-cell']//button[@class='btn btn-default btn-xs dropdown-toggle']");
	By delete_Option = By.xpath("//li[@class='delete']//a");
	...
	By folder_Dropdown = By.xpath("//a[contains(text(),'New Library Folder')]/following::button[@class='btn btn-default btn-xs dropdown-toggle']");
	...
	public void click_Resource_Library_BreadCrumb() {
		DriverFactory.getInstance().getDriver().findElement(resource_Library_BreadCrumb).click();
	}
	...
	public void user_Can_Delete_Folder() throws InterruptedException {
		...
		obj.workroom_Member_Open_Resource_Library();
		this.verify_New_Folder_Created();
