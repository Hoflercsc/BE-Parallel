...
public class UserProfilePage {
	...
	public void clickDirectoryMenu() {
		WebElement directorymenu = DriverFactory.getInstance().getDriver().findElement(By.xpath("//span[contains(text(),'Directory')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", directorymenu);
		// DriverFactory.getInstance().getDriver().findElement(directoryMenu).click();
	}

	public void clickUserSearchAndSendKeys() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(userSearchField).click();
		DriverFactory.getInstance().getDriver().findElement(userSearchField).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(userSearchField).sendKeys(userFirstName + " " + userLastName);
		Thread.sleep(1000);
		DriverFactory.getInstance().getDriver().findElement(userSearchField).sendKeys(Keys.ENTER);
		Thread.sleep(2000);
	}

	public void clickDeactivateUser() {
		DriverFactory.getInstance().getDriver().findElement(deactivateUser).click();
	}
	...
	public void clickDirectoryCloseBtn() {
		WebElement closeBtn1 = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@id='directoryModal']//div[@class='modal-header']//a[1]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
	...
	public void click_SuperTestMan_Dropdown() {
		...
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath(
	...
	public void clickContinueBtn2() {
		DriverFactory.getInstance().getDriver().findElement(continueBtn2).click();
	}

	public void clickCloseModal() {
		WebElement closemodal = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[@id='settingsModalClose']"));
		((JavascriptExecutor) DriverFactory.getInstance().getDriver()).executeScript("arguments[0].scrollIntoView(true);", closemodal);
		WebElement closemodalclick = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[@id='settingsModalClose']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", closemodalclick);
		// DriverFactory.getInstance().getDriver().findElement(closeModal).click();
	}
	...
	public void verify_Username1_Not_Created() throws InterruptedException {
		...
		Boolean name = DriverFactory.getInstance().getDriver().findElements(By.xpath(userFullName)).size() < 1;
	...
	// ------------------ Function Being Called ----------------------
	public void systemAdmin_Search_For_User() throws InterruptedException {
		this.verifyUserSearchField();
		this.clickUserSearchAndSendKeys();
		System.out.println("------- Completed --> System Admin Open Directory Search For User -----------");
	}
	...
	public void clickAddUser() {
		DriverFactory.getInstance().getDriver().findElement(addUserDropdown).click();
	}

	public void clickAddOneUser() {
		DriverFactory.getInstance().getDriver().findElement(addOneUser).click();
	}

	public void newUserFormFill() {
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_FirstName).sendKeys(userFirstName);
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LastName).sendKeys(userLastName);
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LogIn).sendKeys(userLogin);
		DriverFactory.getInstance().getDriver().findElement(newUser_Password).sendKeys(userPassword);
		DriverFactory.getInstance().getDriver().findElement(newUser_PasswordConfirm).sendKeys(userPassword);
		DriverFactory.getInstance().getDriver().findElement(newUser_CompanyEmail).sendKeys(companyEmail);
		DriverFactory.getInstance().getDriver().findElement(newUser_SaveBtn).click();
	}

	public void newUserFormFill2() {
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_FirstName).sendKeys(userFirstNameUpdated);
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LastName).sendKeys(userLastName);
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LogIn).sendKeys(userLoginUpdated);
		DriverFactory.getInstance().getDriver().findElement(newUser_Password).sendKeys(userPassword);
		DriverFactory.getInstance().getDriver().findElement(newUser_PasswordConfirm).sendKeys(userPassword);
		DriverFactory.getInstance().getDriver().findElement(newUser_CompanyEmail).sendKeys(companyEmailUpdated);
		DriverFactory.getInstance().getDriver().findElement(newUser_SaveBtn).click();
	}
	...
	public void scrolldownClickSave() throws InterruptedException {
		...
		((JavascriptExecutor) DriverFactory.getInstance().getDriver()).executeScript("arguments[0].scrollIntoView(true);", SaveBtn);
		Thread.sleep(2000);
		WebElement SaveBtn2 = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@class='modal-dialog modal-lg']//button[@id='save-user']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
	...
	public void clickProfileCloseBtn() throws InterruptedException {
		WebElement closeBtn = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@id='profileModal']//button[@class='btn btn-default'][contains(text(),'Close')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", closeBtn);
		// DriverFactory.getInstance().getDriver().findElement(profileCloseBtn).click();
	}

	public void clickSettingsCloseBtn() throws InterruptedException {
		Thread.sleep(2000);
		DriverFactory.getInstance().getDriver().findElement(settingsCloseBtn).click();
	}
	...
	public void verify_Old_User1_Created() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(supertestman)).size() > 0);
	}
	...
	public void verify_Old_User2_Created() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(elitestman)).size() > 0);
	}
	...
	public void verify_Deactivate_User_inList() throws InterruptedException {
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@class='btn-group small open']//a[contains(text(),'Deactivate User')]"));
	...
	public void clickEliArrowBtn() throws InterruptedException {
		Thread.sleep(2000);
		DriverFactory.getInstance().getDriver().findElement(elitestman).click();
	}

	public void click_Deactivate_User_inList() throws InterruptedException {
		// DriverFactory.getInstance().getDriver().findElement(deactivate_User_inList).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@class='btn-group small open']//a[contains(text(),'Deactivate User')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void clickDeleteUser1() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(deleteUser1).click();
	}

	public void clickDeleteUser2() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(deleteUser2).click();
	}

	public void clickContinueBtn3() {
		DriverFactory.getInstance().getDriver().findElement(continueBtn3).click();
	}
	...
	public void click_Edit_Profile() {
		DriverFactory.getInstance().getDriver().findElement(editProfile).click();
	}

	// -------Function Being called -----------
	public void systemAdmin_Open_WorkroomTab_Add_Workroom_2_User() throws InterruptedException {
		DriverFactory.getInstance().getDriver().navigate().refresh();// ----refresh page ------
		DriverFactory.getInstance().getDriver().navigate().refresh();// ----refresh page ------
		this.verifyWelcomeHeader();
		this.clickDirectoryMenu();
		this.verifyUserSearchField();
	...
	public void click_SettingsTab() {
		WebElement settings = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[contains(text(),'Settings')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", settings);
		// DriverFactory.getInstance().getDriver().findElement(settingsTab).click();
	}

	public void click_ContactTab() {
		WebElement contact = DriverFactory.getInstance().getDriver().findElement(By.xpath("//ul[@class='nav nav-tabs']//a[contains(text(),'Contact')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
	...
	public void updateUserSearchAndSendKeys() throws InterruptedException {
		...
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_FirstName).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_FirstName).clear();
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_FirstName).sendKeys(userFirstNameUpdated);
		// -------upadted lastname field
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LastName).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LastName).clear();
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LastName).sendKeys(userLastNameUpdated);
		// -------upadted login field
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LogIn).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LogIn).clear();
		DriverFactory.getInstance().getDriver().findElement(newUser_Input_LogIn).sendKeys(userLoginUpdated);
		DriverFactory.getInstance().getDriver().findElement(newUser_Password).sendKeys(userPassword);
		DriverFactory.getInstance().getDriver().findElement(newUser_PasswordConfirm).sendKeys(userPassword);
	}
	...
	public void update_Email_SendKeys() throws InterruptedException {
		...
		WebElement companyemail = DriverFactory.getInstance().getDriver().findElement(By.xpath("//input[@id='user_companyemail']"));
		((JavascriptExecutor) DriverFactory.getInstance().getDriver()).executeScript("arguments[0].scrollIntoView(true);", companyemail);
		DriverFactory.getInstance().getDriver().findElement(newUser_CompanyEmail).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(newUser_CompanyEmail).clear();
		DriverFactory.getInstance().getDriver().findElement(newUser_CompanyEmail).sendKeys(companyEmailUpdated);
		WebElement SaveBtn = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@class='modal-dialog modal-lg']//button[@id='save-user']"));
		((JavascriptExecutor) DriverFactory.getInstance().getDriver()).executeScript("arguments[0].scrollIntoView(true);", SaveBtn);
		Thread.sleep(2000);
	...
	public void click_SendKeys_Updated_User_Search() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(userSearchField).click();
		DriverFactory.getInstance().getDriver().findElement(userSearchField).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(userSearchField).sendKeys(userFirstNameUpdated + " " + userLastNameUpdated);
		Thread.sleep(1000);
		DriverFactory.getInstance().getDriver().findElement(userSearchField).sendKeys(Keys.ENTER);
		Thread.sleep(2000);
	}
	...
	public void systemAdmin_Can_Delete_Updated_User() throws InterruptedException {
		// ----- Delete Eli Testman ---------
		// DriverFactory.getInstance().getDriver().navigate().refresh();// this prevents stale element
		// DriverFactory.getInstance().getDriver().navigate().refresh();
		Thread.sleep(2000);
		this.verify_EliTestman_Visible();
		this.clickEliArrowBtn();
	...
	public void verify_UsernameEli_Not_Present() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(eli)).size() < 1);
	}
