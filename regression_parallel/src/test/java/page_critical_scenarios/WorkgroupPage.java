...
public class WorkgroupPage {
	...
	public void verify_New_Group_NewBtn() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(newGroup)));
	}

	public void verify_Add_Group_Name_Field() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(add_group_Name_Field)));
	}
	...
	public void click_Add_NewBtn() {
		...
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//button[@id='add-new']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}

	public void click_New_Group() {
		// DriverFactory.getInstance().getDriver().findElement(newGroup).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[contains(text(),'New Group')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}

	public void click_Group_Name_Field_SendKeys() {
		// DriverFactory.getInstance().getDriver().findElement(add_group_Name_Field).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//input[@id='committeegroup_name']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
		DriverFactory.getInstance().getDriver().findElement(add_group_Name_Field).sendKeys(workGroupName);
	}
	...
	public void click_Active_WorkGroups_Tab() {
		// DriverFactory.getInstance().getDriver().findElement(active_WorkGroups_Tab).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[contains(text(),'Active Workgroups')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void user_Can_Create_New_Group_A() throws InterruptedException {
		Thread.sleep(2000); // adding additional needed wait
		this.verify_AddNewBtn();
		Thread.sleep(1000);
		this.click_Add_NewBtn();
		Thread.sleep(1000);
	...
	public void verify_DeleteBtn() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(deleteBtn)));
	}
	
	public void verify_EditBtn() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(editBtn)));
	}

	public void verify_Delete_Group_Field() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(delete_group_field)));
	}

	public void click_Group_Dropdown_Arrow() {
		// DriverFactory.getInstance().getDriver().findElement(group_Dropdown_Arrow).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[@class='collapsed group-collapse placeholder'][contains(text(),'NewBEWorkGroup')]/following::button[@class='btn btn-default btn-xs dropdown-toggle']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void click_Group_Dropdown_Arrow_A() {
		// DriverFactory.getInstance().getDriver().findElement(group_Dropdown_Arrow).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[@class='collapsed group-collapse placeholder'][contains(text(),'NewGroup')]/following::button[@class='btn btn-default btn-xs dropdown-toggle']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void click_EditBtn() {
		...
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@class='btn-group small pull-right open']//a[contains(text(),'Edit')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void click_Delete_Group_Field_SendKeys() throws InterruptedException {
		// DriverFactory.getInstance().getDriver().findElement(delete_group_field).click();
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//div[@class='modal-body']//input[@class='form-control']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
		Thread.sleep(1000);
		DriverFactory.getInstance().getDriver().findElement(delete_group_field).sendKeys(workGroupName);
	}
	
	public void edit_Group_Field_SendKeys() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(delete_group_field).clear();
		DriverFactory.getInstance().getDriver().findElement(delete_group_field).sendKeys(group);
	}

	public void click_ContinueBtn() {
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath(" //div[starts-with (@id,'confirm-modal-')]//following::button[@class='btn commit btn-danger']"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void click_Active_WorkGroups_Tab_2() {
		DriverFactory.getInstance().getDriver().findElement(active_WorkGroups_Tab_2).click();
	}
