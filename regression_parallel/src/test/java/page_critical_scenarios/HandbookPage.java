...
public class HandbookPage {
	...
	// ---------------user_Opens_Library_Page_For_Workroom()-----------
	...
	public void user_Opens_Library_Page_For_Workroom() throws InterruptedException {
		...
		this.verify_Library();
		this.click_library();
		System.out.println("------- Completed --> user_Opens_Library_Page_For_Workroom() -----------");
	}
	...
	public void verify_New_Handbooks_Btn() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
	...
	// --------------user_Add_CoverPage_To_HandBook----------------------
	By expand_Generate_Coverpage = By.xpath("(//input[@id='book_coverpage']/following::text()[contains(., 'Generate Cover Page')]/following::text()[contains(., 'Expand')])[1]");
	// -------generate coverpage------
	...
	public void verify_Header_1() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(header_1)));
	}
	...
	public void user_Add_CoverPage_To_HandBook() throws InterruptedException {
		this.verify_Header_1();
		this.Fill_Generate_Cover_Page_Form();
		System.out.println("------- Completed --> user_Add_CoverPage_To_HandBook -----------");
	}
	
	// ---------------------------------user_Add_Agenda_To_HandBook----------------------------
	By expand_Generate_Agenda = By
			.xpath("(//input[@id='book_agenda']/following::text()[contains(., 'Generate Agenda')]/following::text()[contains(., 'Expand')])[1]");
	...
	public void user_Add_Agenda_To_HandBook() throws InterruptedException {
		...
		System.out.println("------- Completed --> user_Add_Agenda_To_HandBook -----------");
	}
	
	// --------------------------user_Save_HandBook-----------------------------------
	By handbook_Created_Message = By.xpath("//p[contains(text(),'Successfully created This is a Handbook')]");
	...
	public void user_Add_First_Catagory_To_HandBook() throws InterruptedException {
		...
		Thread.sleep(1000);
		System.out.println("------- Completed --> user_Can_Add_First_Catagory()  -----------");
	}
	...
	public void click_Build_DownBtn() throws InterruptedException {
	...
	public void build_Handbook() throws InterruptedException {
		...
		this.click_Build_DownBtn();
		System.out.println("------- Completed --> build_Handbook()  -----------");
	}
	...
	// -----------Edit Handbook----------------- 
	By handbook_Dropdown = By.xpath("//*[contains(text(),'This is a Handbook')]/following::div[@class='dropdown header-actions']");
	By handbook_Edit_Option = By.xpath("//*[normalize-space(text())='This is a Handbook']/following::div[@class='dropdown header-actions open']//child::a[contains(text(),'Edit')]");

	By edited_Handbook_Dropdown = By.xpath("//*[contains(text(),'This is an Edited Handbook')]/following::div[@class='dropdown header-actions']");
	By edited_Handbook_Delete_Option = By.xpath("//*[normalize-space(text())='This is an Edited Handbook']/following::div[@class='dropdown header-actions open']//child::a[contains(text(),'Delete')]");
	...
	public void verify_Handbook_Edit_Option() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(handbook_Edit_Option)));
	}
	
	public void verify_Edited_Handbook_Delete_Option() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(DriverFactory.getInstance().getDriver()).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(edited_Handbook_Delete_Option)));
	}

	public void click_Handbook_Dropdown() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(handbook_Dropdown).click();
		Thread.sleep(1000);
	}
	
	public void click_Edited_Handbook_Dropdown() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(edited_Handbook_Dropdown).click();
		Thread.sleep(1000);
	}
	
	public void click_Edited_Handbook_Delete_Option() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(edited_Handbook_Delete_Option).click();
		Thread.sleep(1000);
	}

	public void click_Handbook_Edit_Option() throws InterruptedException {
		DriverFactory.getInstance().getDriver().findElement(handbook_Edit_Option).click();
		Thread.sleep(1000);
	}
	...
	public void edit_Handbook() throws InterruptedException {
		...
		this.verify_Handbook_Edit_Option();
		this.click_Handbook_Edit_Option();
		Thread.sleep(1000);
		this.verify_Edit_BookBtn();
	...
	// --------------Function Being Called ---------------------------
	public void delete_Edited_Handbook() throws InterruptedException {
		this.click_Edited_Handbook_Dropdown();
		Thread.sleep(1000);
		this.verify_Edited_Handbook_Delete_Option();
		this.click_Edited_Handbook_Delete_Option();
		Thread.sleep(1000);
	...
	public void verify_Handbook_NOT_Visible() throws InterruptedException {
		String handbook = "//*[contains(text(),'This is an Edited Handbook')]/following::div[@class='dropdown header-actions']";
