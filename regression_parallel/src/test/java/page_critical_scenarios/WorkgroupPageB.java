...
public class WorkgroupPageB {
	...
	By active_WorkGroups_Tab = By.xpath("//*[@id=\"workroom_and_group_setting\"]//ul[@class='nav nav-tabs']/li/a[@aria-controls='active_workgroups']");
	...
	public void click_Active_WorkGroups_Tab() {
		...
		WebElement element = DriverFactory.getInstance().getDriver().findElement(active_WorkGroups_Tab);
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}
	...
	//By group_Dropdown_Arrow = By.xpath("//a[@class='collapsed group-collapse placeholder']/following::div[@class='btn-group small pull-right']");
	...
	public void verify_Group_Not_Present() throws InterruptedException {
		...
		Assert.assertTrue(DriverFactory.getInstance().getDriver().findElements(By.xpath(group)).size() < 1);
	}
	...
	public void click_Active_Workrooms_Tab() {
		WebElement element = DriverFactory.getInstance().getDriver().findElement(By.xpath("//a[contains(text(),'Active Workrooms')]"));
		JavascriptExecutor executor = (JavascriptExecutor) DriverFactory.getInstance().getDriver();
		executor.executeScript("arguments[0].click();", element);
	}

	public void click_DC_Workroom_Dropdown() {
		DriverFactory.getInstance().getDriver().findElement(dc_Workroom_Dropdown).click();
	}

	public void click_Drp_Settings() {
		DriverFactory.getInstance().getDriver().findElement(drp_settings).click();
	}

	public void click_workroom_Group_Dropdown() {
		DriverFactory.getInstance().getDriver().findElement(workroom_Group_dropdown).click();
	}

	public void click_NewBEWorkGroup() {
		DriverFactory.getInstance().getDriver().findElement(newBEWorkGroup).click();
	}
	...
	public void click_Active_Workgroups() {
		DriverFactory.getInstance().getDriver().findElement(active_Workgroups).click();
	}
	...
	public void click_Nested_DC_dropdown() {
		DriverFactory.getInstance().getDriver().findElement(nested_DC_dropdown).click();
	}

	public void click_Null_Dropdown_Option() {
		DriverFactory.getInstance().getDriver().findElement(null_Dropdown_Option).click();
	}
	...
	public void click_Delete_WorkGroup_Field_SendKeys() {
		DriverFactory.getInstance().getDriver().findElement(group_WorkroomField).click();
		DriverFactory.getInstance().getDriver().findElement(group_WorkroomField).sendKeys(workGroupName);
	}
