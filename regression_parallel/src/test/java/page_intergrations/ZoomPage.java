...
public class ZoomPage {
	...
	public void click_Zoom_Configure() {
		DriverFactory.getInstance().getDriver().findElement(zoom_Configure).click();
	}
	...
	public void zoom_Fill_Form() {
		DriverFactory.getInstance().getDriver().findElement(intergration_Name).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(intergration_Name).clear();
		DriverFactory.getInstance().getDriver().findElement(intergration_Name).sendKeys(name);
		DriverFactory.getInstance().getDriver().findElement(zoom_Key_Field).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(zoom_Key_Field).clear();
		DriverFactory.getInstance().getDriver().findElement(zoom_Key_Field).sendKeys(zoomKey);
		DriverFactory.getInstance().getDriver().findElement(Zoon_Secret_Field).sendKeys(Keys.chord(Keys.CONTROL, "a"));
		DriverFactory.getInstance().getDriver().findElement(Zoon_Secret_Field).clear();
		DriverFactory.getInstance().getDriver().findElement(Zoon_Secret_Field).sendKeys(zoomSecret);
	}
