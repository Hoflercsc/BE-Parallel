...
public class AddRemoveProfilePhoto extends BaseTestDirectory {
	...
	@Test(priority = 3, description = "open_Auto_User_1_Profile")
	public void open_Auto_User_1_Profile() throws InterruptedException {
		test.assignCategory("Directory >> Add-Remove-Profile-Photo");
		
		obj_directory = new DirectoryPage();
		obj_directory.open_Auto_User_1_Profile(autoUser1);
	}
	...
	@Test(priority = 6, description = "open_Auto_User_1_Profile_Again")
	public void open_Auto_User_1_Profile_Again() throws InterruptedException {
		test.assignCategory("Directory >> Add-Remove-Profile-Photo");
	...
	@Test(priority = 7, description = "delete_Photo")
	...
	@Test(priority = 8, description = "user_Can_Open_Dirctory_Again")
	...
	@Test(priority = 9, description = "open_Auto_User_1_Profile_3rd_Time")
	public void open_Auto_User_1_Profile_3rd_Time() throws InterruptedException {
		test.assignCategory("Directory >> Add-Remove-Profile-Photo");
	...
	@Test(priority = 10, description = "delete_Photo")
