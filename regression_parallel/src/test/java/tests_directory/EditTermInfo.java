...
public class EditTermInfo extends BaseTestDirectory {
	...
	@Test(priority = 3, description = "open_Auto_User_6_Profile")
	public void open_Auto_User_6_Profile() throws InterruptedException {
		test.assignCategory("Directory >> Edit-Term-Info");
		
		obj_directory = new DirectoryPage();
		obj_directory.open_Auto_User_6_Profile(autoUser6);
	}
