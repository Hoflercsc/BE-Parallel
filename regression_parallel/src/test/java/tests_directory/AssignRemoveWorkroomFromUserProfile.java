...
public class AssignRemoveWorkroomFromUserProfile extends BaseTestDirectory {	
	...
	@Test(priority = 3, description = "open_Auto_User_5_Profile")
	public void open_Auto_User_5_Profile() throws InterruptedException {
		test.assignCategory("Directory >> Assign-Remove-Workroom-From-User-Profile");
		
		obj_directory = new DirectoryPage();
		obj_directory.open_Auto_User_5_Profile(autoUser5);
	}
	...
	@Test(priority = 6, description = "open_Auto_User_5_Profile")
	public void open_Auto_User_5_Profile_Again() throws InterruptedException {
		test.assignCategory("Directory >> Assign-Remove-Workroom-From-User-Profile");
	...
	@Test(priority = 7, description = "remove_Workroom_Auto_Attend_From_Profile")
	public void remove_Workroom_Auto_Attend_From_Profile() throws InterruptedException {
		test.assignCategory("Directory >> Assign-Remove-Workroom-From-User-Profile");
		
		obj_directory = new DirectoryPage();
		obj_directory.remove_Workroom_Auto_Attend_From_Profile();
	}
	...
	@Test(priority = 9, description = "open_Auto_User_5_3rd_Time")
	public void open_Auto_User_5_3rd_Time() throws InterruptedException {
		test.assignCategory("Directory >> Assign-Remove-Workroom-From-User-Profile");
	...
	@Test(priority = 10, description = "verify_Auto_Attend_Workroom_Removed")
	public void verify_Auto_Attend_Workroom_Removed() throws InterruptedException {
		test.assignCategory("Directory >> Assign-Remove-Workroom-From-User-Profile");
		
		obj_directory = new DirectoryPage();
		obj_directory.verify_Auto_Attend_Workroom_Removed();
	}
