...
public class RemoveAttachedBookFromEvent extends BaseTestWorkroomEvents {
	@Test(priority = 1, description = "Scenario Login AutoUser UserName Password.")
	public void autoUser_login() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
	...
	public void user_Can_Open_Events_for_Workroom() throws InterruptedException {
		...
		objAtlasNavBar.admin_Open_Workroom_Marvel_Events();
	}
	...
	public void user_Can_Create_New_Event() throws InterruptedException {
		...
		objectEvent.user_Can_Create_New_Event_RSVPS(event25);
	}

//	@Test(priority = 4, description = "user_Click_Event_25_Accept_As_Response")
//	public void user_Click_Event_25_Accept_As_Response() throws InterruptedException {
//		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
//		
//		objectEvent = new EventPage();
//		objectEvent.user_Click_Event_25_Accept_As_Response();
//	}
	...
	public void user_Can_Create_Book_And_Add_Title() throws InterruptedException {
		...
		objBook.enter_Book_Title(meetingBook5);
	}
	...
	@Test(priority = 14, description = "verify_Meeting_Book_5_Added_To_Event_25_On_Ozzie")
	public void verify_Meeting_Book_5_Added_To_Event_25_On_Ozzie() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
		
		objectEvent = new EventPage();
		objectEvent.verify_Meeting_Book_5_Added_To_Event_25_On_Ozzie();
	}
	
	@Test(priority = 15, description = "remove_Attached_Book_From_Event_25")
	public void remove_Attached_Book_From_Event_25() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
		
		objectEvent = new EventPage();
		objectEvent.remove_Attached_Book_From_Event_25();
	}

	@Test(priority = 16, description = "delete_Event_25")
	public void delete_Event_25() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
	...
	@Test(priority = 17, description = "verify_Event_25_Deleted")
	public void verify_Event_25_Deleted() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
		
		objectEvent = new EventPage();
		objectEvent.verify_Event_25_Deleted();
	}
	
	@Test(priority = 18, description = "user_navigates_To_Book")
	...
	@Test(priority = 19, description = "delete_Meeting_Book_5")
	public void delete_Meeting_Book_5() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
		
		objBook = new BookPage();
		objBook.delete_Meeting_Book_5();
	}
	
	@Test(priority = 20, description = "verify_Book_Deleted")
	public void verify_Book_Deleted() throws InterruptedException {
		test.assignCategory("Workroom-Events >> Remove-Attached-Book-From-Event");
		
		objBook = new BookPage();
		objBook.verify_Meeting_Book_5_NOT_VISIBLE();
	}
