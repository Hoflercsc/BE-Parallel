...
public class SetUserToHidden extends BaseTestSettings {
	...
	@Test(priority = 3, description = "open_User_Profile_Auto_User_17")
	public void open_User_Profile_Auto_User_17() throws InterruptedException {
		test.assignCategory("Set-Permissions >> Set-User-To-Hidden");
		
		objPermissions = new PermissionsPage();
		objPermissions.open_User_Profile_Auto_User_17(autoUser17);
	}
	...
	@Test(priority = 9, description = "verify_Auto_User_17_Not_In_List")
	public void verify_Auto_User_17_Not_In_List() throws InterruptedException {
		test.assignCategory("Set-Permissions >> Set-User-To-Hidden");
		
		objPermissions = new PermissionsPage();
		objPermissions.verify_Test_User_Not_In_List(autoUser17);
		DriverFactory.getInstance().getDriver().navigate().refresh();
	}
