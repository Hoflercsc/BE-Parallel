...
public class SetUserToDisablePrivateDirectory extends BaseTestSettings {
	...
	public void open_User_Profile_Disable_Private_Directory() throws InterruptedException {
		...
		objPermissions.open_User_Profile_Wanda_Martin_Disable_Private_Directory(wandaMartin);
	}
	...
	public void open_User_Profile_Enable_Private_Directory() throws InterruptedException {
		...
		objPermissions = new PermissionsPage();
		objPermissions.open_User_Profile_Wanda_Martin_Enable_Private_Directory(wandaMartin);
	}
