...
//*****However test has been updated and runs correctly *******
public class ViewingAndReplyingToApproval extends BaseTestResourceLibrary {
	...
	@Test(priority = 6, description = "user_Can_Add_File_Folder_8")
	public void user_Can_Add_File_Folder_8() throws InterruptedException {
		test.assignCategory("Resource-Library >> Viewing-And-Replying-To-Approval");
		
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.user_Can_Add_File_Folder_8();
	}
	...
	@Test(priority = 9, description = "user_Can_Verify_Approvers_Added_Folder_8")
	public void user_Can_Verify_Approvers_Added_Folder_8() throws InterruptedException {
		test.assignCategory("Resource-Library >> Viewing-And-Replying-To-Approval");
		
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.user_Can_Verify_Approvers_Added_Folder_8();
	}
	...
	@Test(priority = 18, description = "delete_Resource_Library_Folder_8")
	...
	@Test(priority = 20, description = "verify_Resource_Library_Folder_8_NOT_Present")
