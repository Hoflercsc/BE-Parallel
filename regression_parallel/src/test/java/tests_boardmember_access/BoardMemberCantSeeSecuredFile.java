...
public class BoardMemberCantSeeSecuredFile extends BaseTestBoardMemberAccess {
	...
	public void user_Can_Create_2nd_Resource_Library_Folder() throws InterruptedException {
		...
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.user_Create_Resource_Library_Folder_2(newLibraryFolder2); // create folder
	...
	@Test(priority = 6, description = "user_Can_Add_File_To_Library_Folder_2")
	public void user_Can_Add_File_To_Library_Folder_2() throws InterruptedException {
		test.assignCategory("Board-Member-Access >> Board-Member-Cant-See-Secured-File");
		
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.user_Can_Add_File_To_Library_Folder_2();
	}
	...
	@Test(priority = 11, description = "verify_File_Not_In_New_Library_Folder_2")
	public void verify_File_Not_In_New_Library_Folder_2() throws InterruptedException {
		test.assignCategory("Board-Member-Access >> Board-Member-Cant-See-Secured-File");
		
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.verify_File_Not_In_Library_Folder_2();
		DriverFactory.getInstance().getDriver().navigate().refresh();
	}
	...
	@Test(priority = 15, description = "delete_Resource_Library_Folder_2")
	public void delete_Resource_Library_Folder_2() throws InterruptedException {
		test.assignCategory("Board-Member-Access >> Board-Member-Cant-See-Secured-File");
		
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.delete_Resource_Library_Folder_2();
		DriverFactory.getInstance().getDriver().navigate().refresh();
	}
	...
	@Test(priority = 17, description = "verify_Resource_Library_Folder_2_NOT_Present")
	public void verify_Resource_Library_Folder_2_NOT_Present() throws InterruptedException {
		test.assignCategory("Board-Member-Access >> Board-Member-Cant-See-Secured-File");
		
		obj_move_resource = new MoveResourceFolderPage();
		obj_move_resource.verify_Resource_Library_Folder_2_NOT_Present();
	}
}