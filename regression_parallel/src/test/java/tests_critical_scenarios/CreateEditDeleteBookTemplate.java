...
public class CreateEditDeleteBookTemplate extends BaseTestCriticalScenarios {	
	...
	public void user_Create_New_BookTemplate() throws InterruptedException {
		...
		objectBookTemplate = new BookTemplatePage();
	...
	@Test(priority = 13, description = "delete_Edited_Book_Template")
	public void delete_Edited_Book_Template() throws InterruptedException {
		test.assignCategory("CreateEditDeleteBookTemplate");
		
		objectBookTemplate = new BookTemplatePage();
		objectBookTemplate.delete_Edited_Book_Template();
	}

	@Test(priority = 14, description = "verify_Edited_Book_Template_Deleted")
	public void verify_Edited_Book_Template_Deleted() throws InterruptedException {
		test.assignCategory("CreateEditDeleteBookTemplate");
		
		objectBookTemplate = new BookTemplatePage();
		objectBookTemplate.verify_Edited_Book_Template_Deleted();
	}
}