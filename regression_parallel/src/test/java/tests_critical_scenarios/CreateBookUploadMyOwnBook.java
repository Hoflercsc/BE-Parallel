...
public class CreateBookUploadMyOwnBook extends BaseTestCriticalScenarios {
	...
	public void user_Can_Create_New_Book() throws InterruptedException {
		...
		objectMyOwnBook = new MyOwnBookPage();
	...
	@Test(priority = 4, description = "user_Can_Make_Upload_Book_Visible")
	public void user_Can_Make_Upload_Book_Visible() throws InterruptedException {
		test.assignCategory("CreateBookUploadMyOwnBook");
		
		objectMyOwnBook = new MyOwnBookPage();
		objectMyOwnBook.user_Can_Make_Upload_Book_Visible();
	}
	...
	public void user_Can_Delete_Book() throws InterruptedException {
		...
		objectMyOwnBook = new MyOwnBookPage();
		objectMyOwnBook.delete_Upload_My_Own_Book();
	}
