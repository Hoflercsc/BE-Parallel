...
public class CopyMeetingBookToTemplate extends BaseTestWorkroomLibrary {
	...
	public void user_Can_Create_Book_And_Add_Title() throws InterruptedException {
		...
		obj_meeting_book.user_Can_Create_New_Book(meetingBook22);
	}
	...
	@Test(priority = 11, description = "copy_Meetings_Book_21_To_Template")
	public void copy_Meetings_Book_21_To_Template() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Copy-Meeting-Book-To-Template");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.copy_Meetings_Book_22_To_Template(meetingBook23);
	}
	
	@Test(priority = 12, description = "delete_Meeting_Book_22")
	public void delete_Meeting_Book_22() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Copy-Meeting-Book-To-Template");

		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_22();
	}

	@Test(priority = 13, description = "delete_Meeting_Book_23")
	public void delete_Meeting_Book_23() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Copy-Meeting-Book-To-Template");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_23();
	}

	@Test(priority = 14, description = "verify_Meeting_Book_22_23_NOT_VISIBLE")
	public void verify_Meeting_Book_22_23_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Copy-Meeting-Book-To-Template");

		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_22_23_NOT_VISIBLE();
	}
}