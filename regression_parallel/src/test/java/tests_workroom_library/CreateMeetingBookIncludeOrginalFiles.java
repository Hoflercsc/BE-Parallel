...
public class CreateMeetingBookIncludeOrginalFiles extends BaseTestWorkroomLibrary {
	@Test(priority = 1, description = "Login System Admin UserName Password.")
	public void systemAdmin_login() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Create-Meeting-Book-Include-Orginal-Files");
	...
	public void user_Can_Create_New_Book_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook27);
	}
	...
	@Test(priority = 9, description = "enable_Include_Orginal_Files_For_Book")
	public void enable_Include_Orginal_Files_For_Book() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Create-Meeting-Book-Include-Orginal-Files");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.enable_Include_Orginal_Files_For_Book();
	}
	...
	public void make_Scanned_Bmake_Meeting_Book_Visibleook_Visible() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Create-Meeting-Book-Include-Orginal-Files");
	...
	public void verify_Watermark() throws InterruptedException {
		...
		obj_meeting_book.navigate_To_Edit_Status_Book_27();
		obj_meeting_book.verify_Include_Orginal_Files_Checked();
		objectScannedPDF.click_Workroom_Library_Crumb();
		Thread.sleep(1000);
	}
	
	@Test(priority = 13, description = "delete_Meeting_Book_27")
	public void delete_Meeting_Book_27() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Create-Meeting-Book-Include-Orginal-Files");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_27();
	}

	@Test(priority = 14, description = "verify_Meeting_Book_27_NOT_VISIBLE")
	public void verify_Meeting_Book_27_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Create-Meeting-Book-Include-Orginal-Files");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_27_NOT_VISIBLE();
	}
}