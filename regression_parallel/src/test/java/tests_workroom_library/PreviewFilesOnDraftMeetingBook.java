...
public class PreviewFilesOnDraftMeetingBook extends BaseTestWorkroomLibrary {
	@Test(priority = 1, description = "Login System Admin UserName Password.")
	public void systemAdmin_login() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Preview-Files-On-Draft-Meeting-Book");
	...
	public void user_Can_Create_New_Book_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook37);
	}
	...
	@Test(priority = 10, description = "make_Meeting_Book_Visible")
	...
	@Test(priority = 11, description = "navigate_To_Edit_Preview_File")
	public void navigate_To_Edit_Preview_File() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Preview-Files-On-Draft-Meeting-Book");
		
		objectScannedPDF = new BookScannedPDFPage();
		obj_meeting_book = new BookPage();

		obj_meeting_book.navigate_To_Edit_Status_Verify_Book_37();
		objectScannedPDF.preview_Files();
	}
	
	@Test(priority = 12, description = "delete_Meeting_Book_37")
	public void delete_Meeting_Book_37() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Preview-Files-On-Draft-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_37();
	}

	@Test(priority = 13, description = "verify_Meeting_Book_37_NOT_VISIBLE")
	public void verify_Meeting_Book_37_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Preview-Files-On-Draft-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_37_NOT_VISIBLE();
	}
}