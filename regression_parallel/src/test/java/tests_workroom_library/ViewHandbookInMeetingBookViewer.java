...
public class ViewHandbookInMeetingBookViewer extends BaseTestWorkroomLibrary {
	...
	public void user_Can_Create_New_Handbook() throws InterruptedException {
		...
		obj_meeting_book.user_Can_Create_New_Handbook(handBook9);
	}
	...
	@Test(priority = 14, description = "delete_Handbook_9")
	public void delete_Handbook_9() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> View-Handbook-In-Meeting-Book-Viewer");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Handbook_9();
	}
	...
	@Test(priority = 16, description = "verify_Handbook_9_NOT_Visible")
	public void verify_Handbook_9_NOT_Visible() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> View-Handbook-In-Meeting-Book-Viewer");

		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Handbook_9_NOT_Visible();
	}
}