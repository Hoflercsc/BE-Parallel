...
public class ArchiveRestoreMeetingBook extends BaseTestWorkroomLibrary {
	@Test(priority = 1, description = "Login UserName Password.")
	public void autoUser_login() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Archive-Restore-Meeting_Book");
	...
	public void user_Can_Create_Book_And_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook17);
	}
	...
	@Test(priority = 11, description = "archive_Meeting_Book_17")
	public void archive_Meeting_Book_17() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Archive-Restore-Meeting_Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.archive_Meeting_Book_17();
	}
	
	@Test(priority = 12, description = "restore_Meeting_Book_17")
	public void restore_Meeting_Book_17() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Archive-Restore-Meeting_Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.restore_Meeting_Book_17();
	}
	
	@Test(priority = 13, description = "delete_Meeting_Book_17")
	public void delete_Meeting_Book_17() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Archive-Restore-Meeting_Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_17();
	}

	@Test(priority = 14, description = "verify_Meeting_Book_17_NOT_VISIBLE")
	public void verify_Meeting_Book_17_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Archive-Restore-Meeting_Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_17_NOT_VISIBLE();
	}
}