...
public class CopyHandBook extends BaseTestWorkroomLibrary {
	...
	public void autoUser_login() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Hand-Book");
	...
	public void user_Can_Create_New_Handbook() throws InterruptedException {
		...
		obj_meeting_book.user_Can_Create_New_Handbook(handBook3);
	}
	...
	@Test(priority = 11, description = "Workroom-Library >> Copy-Hand-Book")
	public void copy_Handbook_3() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Hand-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.copy_Handbook_3(handBook4);
	}
	...
	public void delete_Handbook_3() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Handbook_3();
	...
	public void delete_Handbook_4() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Handbook_4();
		obj_meeting_book.navigate_Back_To_Handbook_2();
	}

	@Test(priority = 14, description = "verify_Handbook_3_4_NOT_Visible")
	public void verify_Handbook_3_4_NOT_Visible() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Hand-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Handbook_3_4_NOT_Visible();
	}
}