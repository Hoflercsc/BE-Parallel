...
public class EditAgendasFontStyling extends BaseTestWorkroomLibrary {
	...
	public void user_Can_Create_New_Book_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook31);
	}
	...
	public void navigate_To_Edit_Agenda_Font_Stylings() throws InterruptedException {
		...
		obj_meeting_book.navigate_To_Edit_Status_Book_31();
	...
	public void navigate_Verify_Agenda_Font_Stylings() throws InterruptedException {
		...
		objectScannedPDF = new BookScannedPDFPage();
		obj_meeting_book.navigate_To_Edit_Status_Book_31();
		objectScannedPDF.veirfy_Font_Styling_Selected_Book31();
	}
	
	@Test(priority = 14, description = "delete_Meeting_Book_31")
	public void delete_Meeting_Book_31() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Edit-Agendas-Font-Styling");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_31();
	}
	...
	public void verify_Scanned_Book_Deleted() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_31_NOT_VISIBLE();
	}
}