...
public class CopyMeetingBook extends BaseTestWorkroomLibrary {
	@Test(priority = 1, description = "Login UserName Password.")
	public void autoUser_login() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
	...
	public void user_Can_Create_Book_And_Add_Title() throws InterruptedException {
		...
		obj_meeting_book.user_Can_Create_New_Book(meetingBook20);
	}
	...
	@Test(priority = 11, description = "copy_Meeting_Book_20")
	public void copy_Meeting_Book_20() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.copy_Meeting_Book_20(meetingBook21);
	}
	
	@Test(priority = 12, description = "verify_Meeting_Book_21_22_VISIBLE")
	public void verify_Meeting_Book_21_22_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_20_21_VISIBLE();
	}
	
	@Test(priority = 13, description = "delete_Meeting_Book_20")
	public void delete_Meeting_Book_20() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_20();
	}
	
	@Test(priority = 14, description = "delete_Meeting_Book_21")
	public void delete_Meeting_Book_21() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_21();
	}

	@Test(priority = 15, description = "verify_Meeting_Book_20_21_NOT_VISIBLE")
	public void verify_Meeting_Book_20_21_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Library >> Copy-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_20_21_NOT_VISIBLE();
	}
}