...
public class AddContributorsToBookTemplate extends BaseTestWorkroomLibrary {	
	...
	public void user_Create_New_BookTemplate() throws InterruptedException {
		...
		obj_meeting_book.user_Create_New_BookTemplate(meetingBook6);
	}
	...
	@Test(priority = 11, description = "delete_Meeting_Book_6")
	public void delete_Meeting_Book_6() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Add-Contributors-To-Book-Template");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_6();
	}
	...
	@Test(priority = 13, description = "verify_Meeting_Book_6_NOT_VISIBLE")
	public void verify_Meeting_Book_6_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Add-Contributors-To-Book-Template");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_6_NOT_VISIBLE();
	}
}