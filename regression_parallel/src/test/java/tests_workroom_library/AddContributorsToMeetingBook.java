...
public class AddContributorsToMeetingBook extends BaseTestWorkroomLibrary {
	...
	public void systemAdmin_login() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Add-Contributors-And-Email-To-Meeting-Book");
	...
	public void user_Can_Create_New_Book_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook7);
	}
	...
	@Test(priority = 12, description = "make_Meeting_Book_Visible")
	...
	public void delete_Scanned_Book() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_7();
	}
	...
	public void verify_Scanned_Book_Deleted() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_7_NOT_VISIBLE();
	}
}