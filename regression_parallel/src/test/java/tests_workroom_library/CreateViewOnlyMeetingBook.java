...
public class CreateViewOnlyMeetingBook extends BaseTestWorkroomLibrary {
	...
	public void user_Can_Create_New_Book_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook30);
	}
	...
	public void nonAdmin_Open_Library_Page_For_Workroom() throws InterruptedException {
		...
		objAtlasNavBar = new AtlasNavBar();
		objAtlasNavBar.workroom_Member_Open_Workroom_Planet_Library_Page();
	}
	...
	public void verify_Book_30_Is_View_Only() throws InterruptedException {
		...
		objectScannedPDF = new BookScannedPDFPage();
		objectScannedPDF.verify_Book_30_Is_View_Only();
	}
	...
	@Test(priority = 19, description = "delete_Meeting_Book_30")
	public void delete_Meeting_Book_30() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Create-View-Only-Meeting-Book");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_30();
	}
	...
	public void verify_Meeting_Book_30_NOT_VISIBLE() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_30_NOT_VISIBLE();
	}
}