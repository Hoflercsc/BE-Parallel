...
public class RemoveWorkflowForMeetingBookFile extends BaseTestWorkroomLibrary {
	@Test(priority = 1, description = "Login System Admin UserName Password.")
	public void systemAdmin_login() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Remove-Workflow-For-Meeting-Book-File");
	...
	public void user_Can_Create_New_Book_Add_Title() throws InterruptedException {
		...
		objectScannedPDF.user_Can_Create_New_Book_Add_Title(meetingBook38);
	}
	...
	@Test(priority = 10, description = "Add_Ordered_Approval_Users_SystemAdminEng_WorkroomAdminEng2")
	public void Add_Ordered_Approval_Users_SystemAdminEng_WorkroomAdminEng2() throws InterruptedException {
		...
		objectSecuredCategory.Add_Ordered_Approval_Users_SystemAdminEng_WorkroomAdminEng2();
	}
	...
	public void force_Workflow_Approvals_And_Finalize_Responses() throws InterruptedException {
		...
		obj_meeting_book = new BookPage();
		obj_meeting_book.force_Workflow_Approvals_Book_38();
		obj_meeting_book.finalize_Workflow_Response_Updated();
	}
	
	@Test(priority = 13, description = "delete_Workflow")
	public void delete_Workflow() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Remove-Workflow-For-Meeting-Book-File");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Workflow();
	}
	
	@Test(priority = 14, description = "user_Can_Build_Book")
	...
	@Test(priority = 15, description = "make_Scanned_Book_Visible")
	...
	@Test(priority = 16, description = "delete_Scanned_Book")
	public void delete_Scanned_Book() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Remove-Workflow-For-Meeting-Book-File");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.delete_Meeting_Book_38();
	}

	@Test(priority = 17, description = "verify_Meeting_Book_38_NOT_VISIBLE")
	public void verify_Meeting_Book_38_NOT_VISIBLE() throws InterruptedException {
		test.assignCategory("Workroom-Libary >> Remove-Workflow-For-Meeting-Book-File");
		
		obj_meeting_book = new BookPage();
		obj_meeting_book.verify_Meeting_Book_38_NOT_VISIBLE();
	}
}