...
public class BaseTestWorkroomHome {
	// -------Reference Variables-------------
	// ----- Regression Test Cases -----
	LoginLogoutPage objBELogin;
	LineBreaksPage obj_linebreaks;
	IframeVideoPage obj_iframevideo;
	UploadedImagePage obj_uploaded_image;
	LargeSrcDataPage obj_source_data;
