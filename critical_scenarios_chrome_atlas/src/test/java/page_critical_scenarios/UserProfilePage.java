...
public class UserProfilePage {
	...
	By supertestman = By.xpath("//a[contains(text(),'Super Testman')]/following::div[@class='btn-group small open']//button[@class='btn btn-default btn-xs dropdown-toggle']");
	...
	public void click_SuperTestMan_Dropdown() {
		...
		WebElement element = driver.findElement(By.xpath("(//a[contains(text(),'Super Testman')]/following::div[@class='btn-group small']//button[@class='btn btn-default btn-xs dropdown-toggle'])[1]"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element);
	}
	...
	public void form_Input_Field_SendKeys() throws InterruptedException {
		driver.findElement(formInputField).click();
		driver.findElement(formInputField).sendKeys(userLastName);
	}
	
	public void form_Input_Field_SendKeys_2() throws InterruptedException, AWTException {
		
		driver.findElement(formInputField).click();
		driver.findElement(formInputField).sendKeys(userLastName);
		Thread.sleep(2000);
		
		// when i force the click by css selector or xpath i get message 
		WebElement element = driver.findElement(By.xpath("//button[@class='btn commit btn-danger']"));
		//WebElement element = driver.findElement(By.cssSelector("button.btn.commit.btn-danger:nth-child(2)"));
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].click();", element);
	}
	...
	By continueBtn3 = By.xpath("//*[starts-with (@id,'confirm-modal-')]/div/div/div[3]/button[2]");
	//By continueBtn3 = By.xpath("//div[starts-with(@id,'confirm-modal-')]//button[@class='btn commit btn-danger']");
	// By continueBtn4 = By.xpath("(//button[@class='btn commit btn-danger'][contains(text(),'Continue')])[4]");
	...
	public void verify_ContinueBtn3_Clickable() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(continueBtn3)));
	}
	...
	// -----------Function Being Called ------------------------
 /*	
	public void systemAdmin_Open_InactiveUsersTab_Delete_Old_Users() throws InterruptedException, AWTException {
		...
		this.form_Input_Field_SendKeys_2();
		Thread.sleep(2000);
		//this.verify_ContinueBtn3_Clickable();
...
*/
	...
	By autoBE = By.xpath("//div[@id='workrooms-tab']//li//span[contains(text(),'AutoBE')]");
