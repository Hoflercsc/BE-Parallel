...
public class MessagePage {
	...
	public void click_Message_Workroom() {
		driver.findElement(mesage_Workroom).click();
	}
	...
	public void click_Add_EmailBtn() {
		driver.findElement(add_EmailBtn).click();
	}
	...
	public void verify_AD_TAG_NOT_Visible() throws InterruptedException {
		...
		Assert.assertTrue(driver.findElements(By.xpath(discussion)).size() < 1);
	}
	...
	public void click_Email_Subject_SendKeys() {
		...
		driver.findElement(email_Subject).sendKeys(subject);
	}
	...
	By at_Message = By.xpath("//p[contains(text(),'Automation Tester - automationTester@diligent.com')]");
	...
	public void verify_All_Success_Messages() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(20)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
		wait.until(ExpectedConditions.or(ExpectedConditions.elementToBeClickable(at_Message), ExpectedConditions.elementToBeClickable(wa_Message)));
	}
