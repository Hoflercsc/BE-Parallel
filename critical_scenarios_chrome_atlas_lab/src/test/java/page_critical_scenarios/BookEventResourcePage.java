...
public class BookEventResourcePage {
	...
	public void verify_Build_Book() {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(50)).pollingEvery(Duration.ofMillis(600))
				.ignoring(NoSuchElementException.class);
	...
	public void click_Events_Menu_2() throws InterruptedException {
		driver.findElement(eventsMenu_2).click();
	}
	...
	public void verify_Event_Deleted() throws InterruptedException {
		String element = "//a[contains(text(),'This is a New Event Title')]/following::button[@class='btn btn-default dropdown-toggle']";
