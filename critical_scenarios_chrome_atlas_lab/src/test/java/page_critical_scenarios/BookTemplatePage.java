...
public class BookTemplatePage {
	...
	//By main_Catagory_2 = By.xpath("//body[@class='books edit inside drawer drawer--right']/div[@id='wrap']/main/div[@class='content-main']/div[@class='be-container']/div[@class='row']/div[@class='col-md-10 narrow meeting-details']/div[@class='meeting-book']/div[@class='form']/div[@class='category-accordion ui-sortable']/a[2]");
