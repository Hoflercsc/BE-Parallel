...
public class SurveyPage {
	...
	By surveySucessMessage = By.xpath("//div//p[contains(text(),'Successfully created This is a Survey Title')]");
	// ---Text Field Question ----------
	...
	By surveySucessResponseMessage = By.xpath("//div//p[contains(text(),'Successfully responded to survey: This is a Survey Title')]");
